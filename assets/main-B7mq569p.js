import{m as G,c as Rt,a as Ze,f as Tn,h as rt,M as Fs,P as zs}from"./note-map-ClIaVDR2.js";class Vs{constructor(e){this.notes=Array.from({length:e},()=>({greenMs:0,scoredMs:0,activeMs:0,sumCents:0,centsMs:0})),this.g={ms:0,sumC:0,sumC2:0,reversals:0,lastC:null,lastDir:0}}record(e,n,a,s,i=null){const o=this.notes[e];if(o&&(o.activeMs+=a,!!s&&(o.scoredMs+=a,n==="green"?o.greenMs+=a:n==="yellow"&&(o.greenMs+=a*.5),i!=null&&Number.isFinite(i)))){o.sumCents+=i*a,o.centsMs+=a;const c=this.g;if(c.ms+=a,c.sumC+=i*a,c.sumC2+=i*i*a,c.lastC!=null){const l=i-c.lastC;if(Math.abs(l)>2){const r=l>0?1:-1;c.lastDir&&r!==c.lastDir&&(c.reversals+=1),c.lastDir=r}}c.lastC=i}}result(){let e=0,n=0,a=0,s=0,i=0;for(const d of this.notes)e+=d.greenMs,n+=d.activeMs,a+=d.sumCents,s+=d.centsMs,d.activeMs>0&&d.greenMs/d.activeMs>=.5&&(i+=1);const o=n>0?e/n:0,c=o>=.85?3:o>=.6?2:o>=.35?1:0,l=this.g;let r=0;if(l.ms>0){const d=l.sumC/l.ms,f=Math.max(0,l.sumC2/l.ms-d*d);r=Math.sqrt(f)}const u=l.ms/1e3,h=u>0?l.reversals/2/u:0,v=h>=3.5&&h<=8.5&&r>=15&&r<=130;return{pct:o,stars:c,notesHit:i,notesTotal:this.notes.length,avgCents:s>0?a/s:0,perNote:this.notes.map(d=>d.activeMs>0?d.greenMs/d.activeMs:0),stability:r,vibrato:{present:v,rateHz:h}}}}const tn={light:{grid:"rgba(27,36,48,.07)",gridC:"rgba(27,36,48,.18)",label:"rgba(27,36,48,.42)",hitLine:"rgba(14,141,127,.6)",note:"rgba(14,141,127,.26)",noteActive:"rgba(14,141,127,.95)",noteGlow:"rgba(14,141,127,.5)",green:"#2fab84",yellow:"#e0a64a",red:"#e0544b",free:"#0e8d7f",glow:0},dark:{grid:"rgba(255,255,255,.055)",gridC:"rgba(255,255,255,.14)",label:"rgba(255,255,255,.45)",hitLine:"rgba(61,229,201,.7)",note:"rgba(61,229,201,.2)",noteActive:"rgba(61,229,201,.95)",noteGlow:"rgba(61,229,201,.85)",green:"#3ee6a8",yellow:"#ffc24d",red:"#ff6b61",free:"#3de5c9",glow:10}};class Ns{constructor(e,n,a={}){this.theme=tn[a.theme]||tn.light,this.canvas=e,this.ctx=e.getContext("2d"),this.ex=n,this.secPerBeat=60/(n.tempo||90),this.greenCents=n.greenCents||20,this.yellowCents=n.yellowCents||40,this.pxPerSec=a.pxPerSec||150,this.hitFrac=a.hitFrac??.26,this.leadIn=a.leadIn??2.2;let s=this.leadIn;this.timed=n.notes.map(o=>{const c=o.beats*this.secPerBeat,l={midi:o.midi,hz:G(o.midi),start:s,end:s+c,dur:c};return s+=c+(o.gap||0)*this.secPerBeat,l}),this.totalTime=s+.6;const i=n.notes.map(o=>o.midi);this.minMidi=Math.min(...i)-3,this.maxMidi=Math.max(...i)+3,this.trail=[]}yFor(e,n){const a=G(this.minMidi),s=G(this.maxMidi),i=Math.max(a,Math.min(s,e)),o=Math.log2(i/a)/Math.log2(s/a);return n-o*n}activeAt(e){for(let n=0;n<this.timed.length;n++)if(e>=this.timed[n].start&&e<this.timed[n].end)return{index:n,seg:this.timed[n]};return null}evaluate(e,n,a){const s=this.activeAt(e);if(!s)return{index:-1,zone:null,voiced:!1};if(!a||!n)return{index:s.index,zone:"red",voiced:!1};const i=Math.abs(Rt(n,s.seg.hz));return{index:s.index,zone:Ze(i,this.greenCents,this.yellowCents),voiced:!0}}draw(e,n,a){const s=this.ctx,i=this.canvas.clientWidth,o=this.canvas.clientHeight,c=i*this.hitFrac;s.clearRect(0,0,i,o);const l=this.theme;for(let g=Math.ceil(this.minMidi);g<=this.maxMidi;g++){const y=this.yFor(G(g),o),w=Tn(g),A=w&&w.startsWith("C");s.strokeStyle=A?l.gridC:l.grid,s.lineWidth=1,s.beginPath(),s.moveTo(0,y),s.lineTo(i,y),s.stroke(),A&&(s.fillStyle=l.label,s.font="10px Inter, sans-serif",s.fillText(w,4,y-3))}s.strokeStyle=l.hitLine,s.lineWidth=2,s.setLineDash([5,6]),s.beginPath(),s.moveTo(c,0),s.lineTo(c,o),s.stroke(),s.setLineDash([]);const r=this.activeAt(e),u=r?r.index:-1,h=16;for(let g=0;g<this.timed.length;g++){const y=this.timed[g],w=c+(y.start-e)*this.pxPerSec,A=y.dur*this.pxPerSec;if(w+A<-20||w>i+20)continue;const L=this.yFor(y.hz,o),p=g===u,S=8;s.fillStyle=p?l.noteActive:l.note,Os(s,w,L-h/2,Math.max(A,10),h,S),s.fill(),p&&(s.shadowColor=l.noteGlow,s.shadowBlur=18+l.glow,s.fill(),s.shadowBlur=0)}let v=null,d="#5e6b7a";if(a&&n)if(v=this.yFor(n,o),r){const g=Ze(Math.abs(Rt(n,r.seg.hz)),this.greenCents,this.yellowCents);d=g==="green"?l.green:g==="yellow"?l.yellow:l.red}else d=l.free;for(this.trail.push(v);this.trail.length>70;)this.trail.shift();const f=this.trail.length,m=2.2;s.strokeStyle=d,s.lineWidth=3,s.lineJoin="round",s.globalAlpha=.45,l.glow&&(s.shadowColor=d,s.shadowBlur=l.glow),s.beginPath();let b=!1;for(let g=0;g<f;g++){const y=this.trail[g];if(y==null){b=!1;continue}const w=c-(f-1-g)*m;b?s.lineTo(w,y):(s.moveTo(w,y),b=!0)}s.stroke(),s.shadowBlur=0;for(let g=0;g<f;g++){const y=this.trail[g];if(y==null)continue;const w=c-(f-1-g)*m;s.globalAlpha=.12+g/f*.5,s.fillStyle=d,s.beginPath(),s.arc(w,y,2,0,Math.PI*2),s.fill()}s.globalAlpha=1,v!=null&&(s.fillStyle=d,s.shadowColor=d,s.shadowBlur=16,s.beginPath(),s.arc(c,v,7,0,Math.PI*2),s.fill(),s.shadowBlur=0)}}function Os(t,e,n,a,s,i){const o=Math.min(i,s/2,a/2);t.beginPath(),t.moveTo(e+o,n),t.arcTo(e+a,n,e+a,n+s,o),t.arcTo(e+a,n+s,e,n+s,o),t.arcTo(e,n+s,e,n,o),t.arcTo(e,n,e+a,n,o),t.closePath()}const js=(()=>{try{return/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||(navigator.maxTouchPoints||0)>1}catch{return!1}})(),_s=js?2.8:1.8;let Sn=_s,kt=null;function ce(t){if(!(!Number.isFinite(t)||t<=0)&&(Sn=t,kt&&kt.__rtGain))try{kt.__rtGain.gain.setTargetAtTime(t,kt.currentTime,.02)}catch{}}function Bn(t){if(t.__rtMaster)return kt=t,t.__rtMaster;const e=t.createDynamicsCompressor();e.threshold.value=-10,e.knee.value=24,e.ratio.value=4,e.attack.value=.003,e.release.value=.25;const n=t.createGain();return n.gain.value=Sn,e.connect(n).connect(t.destination),t.__rtMaster=e,t.__rtGain=n,kt=t,e}function vt(t,e,n=.6,a=0,s=.22,i="piano"){const o=t.currentTime+a,c=t.createGain();c.connect(Bn(t));const l=[];let r=n;const u=(h,v,d,f)=>{const m=t.createOscillator(),b=t.createGain();m.type=h,m.frequency.value=v,b.gain.value=d,m.connect(b).connect(f),m.start(o),m.stop(o+r+.08),l.push(m)};if(i==="piano")r=Math.max(1.6,n),c.gain.setValueAtTime(1e-4,o),c.gain.linearRampToValueAtTime(s,o+.008),c.gain.exponentialRampToValueAtTime(1e-4,o+r),[[1,1],[2,.5],[3,.25],[4,.12]].forEach(([h,v])=>u("sine",e*h,v,c));else if(i==="guitar"){r=Math.max(1.3,n);const h=t.createBiquadFilter();h.type="lowpass",h.frequency.setValueAtTime(3800,o),h.frequency.exponentialRampToValueAtTime(700,o+r),h.connect(c),c.gain.setValueAtTime(1e-4,o),c.gain.linearRampToValueAtTime(s,o+.006),c.gain.exponentialRampToValueAtTime(1e-4,o+r),[[1,1],[2,.32]].forEach(([v,d])=>u("sawtooth",e*v,d,h))}else r=Math.max(.2,n),c.gain.setValueAtTime(0,o),c.gain.linearRampToValueAtTime(s,o+.025),c.gain.setValueAtTime(s,o+Math.max(.05,r-.1)),c.gain.linearRampToValueAtTime(0,o+r),u("triangle",e,1,c),u("triangle",e*2,.18,c);return{dur:n,stop(){try{l.forEach(h=>{h.stop(),h.disconnect()}),c.disconnect()}catch{}}}}function en(t,e,n=0,a=1.4,s=.14,i="piano"){return[0,4,7].forEach(o=>{const c=440*Math.pow(2,(e+o-69)/12);vt(t,c,a,n,s,i)}),a}function Gs(t,e,n=.42,a="piano"){return e.forEach((s,i)=>vt(t,s,n*.9,i*n,.22,a)),e.length*n}function Kt(t,e=0,n=!1){const a=t.currentTime+e,s=t.createOscillator(),i=t.createGain();s.frequency.value=n?1600:1050;const o=n?.4:.26;i.gain.setValueAtTime(1e-4,a),i.gain.exponentialRampToValueAtTime(o,a+.005),i.gain.exponentialRampToValueAtTime(1e-4,a+.08),s.connect(i).connect(Bn(t)),s.start(a),s.stop(a+.1)}function In(t,e,n,a=.05){const s=[0,7,12].map(i=>{const o=440*Math.pow(2,(e+i-69)/12);return vt(t,o,n,0,a,"soft")});return{stop(){try{s.forEach(i=>i.stop())}catch{}}}}const Jt=[{key:"ionian",name:"Ионийский (мажор)",intervals:[0,2,4,5,7,9,11],tier:"free"},{key:"aeolian",name:"Эолийский (минор)",intervals:[0,2,3,5,7,8,10],tier:"standard"},{key:"dorian",name:"Дорийский",intervals:[0,2,3,5,7,9,10],tier:"pro"},{key:"phrygian",name:"Фригийский",intervals:[0,1,3,5,7,8,10],tier:"pro"},{key:"lydian",name:"Лидийский",intervals:[0,2,4,6,7,9,11],tier:"pro"},{key:"mixolydian",name:"Миксолидийский",intervals:[0,2,4,5,7,9,10],tier:"pro"},{key:"locrian",name:"Локрийский",intervals:[0,1,3,5,6,8,10],tier:"pro"},{key:"harm_major",name:"Гармонический мажор",intervals:[0,2,4,5,7,8,11],tier:"pro"},{key:"harm_minor",name:"Гармонический минор",intervals:[0,2,3,5,7,8,11],tier:"pro"}],nn={free:0,standard:1,pro:2};function Te(t){return Jt.find(e=>e.key===t)||Jt[0]}function Cn(t,e="free"){const n=Te(t);return nn[n.tier]<=nn[e||"free"]}function Ws(t,e){const n=e.intervals,a=Math.round(t)-1,s=Math.floor(a/7),i=(a%7+7)%7;return n[i]+12*s}function yt(t,e){const n=Te(e);return t.map(a=>Ws(a,n))}const z=(t,e=1,n=0)=>n?{midi:t,beats:e,gap:n}:{midi:t,beats:e};function An(t){const e=(n,a,s=0)=>z(t+n,a,s);return{id:"vhold",name:"Calm Down Vowels",syllable:"И-Э-А-О-У",tempo:78,kind:"vowel",root:t,grooveStyle:"soft",greenCents:25,desc:"Унификация гласных: держим позицию, меняем только гласную «И-Э-А-О-У».",how:"Пой «И-Э-А-О-У» ровно, без «прыжков» голосом при смене гласной. Сначала стаккато с паузами, потом строка повторяется выше — позиция единая.",notes:[e(0,.5,.5),e(0,.5,.5),e(0,.5,.5),e(0,.5,.5),e(0,.5,.5),e(0,.5),e(0,.5),e(0,.5),e(0,.5),e(0,1),e(4,.25),e(4,.25),e(4,.25),e(4,.25),e(4,1,2),e(4,.25),e(4,.25),e(4,.25),e(4,.25),e(4,1)]}}function Hn(t){const e=(n,a)=>z(t+n,a);return{id:"vscale",name:"Disco Vowels",syllable:"И-Э-А-О-У",tempo:124,kind:"scale",root:t,grooveStyle:"pop",desc:"Точность высоты при смене гласной — каждая гласная ведёт по двум нотам.",how:"Пой «И-Э-А-О-У» легко и точно, попадая в каждую ноту слига. Не зажимайся.",notes:[e(0,.5),e(2,.5),e(5,.5),e(7,.5),e(9,.5),e(7,.5),e(5,.5),e(2,.5),e(7,1),e(5,3)]}}function Rn(t){return{id:"vagil",name:"No Bubble Gum",syllable:"И-Э-И-А-И-О-И-У",tempo:100,kind:"agility",root:t,grooveStyle:"funk",desc:"Беглость и точность: зигзаг по ступеням вверх и обратно.",how:"Лёгко и быстро веди голос по нотам зигзагом вверх, не зажимаясь. Гласные чёткие.",notes:[0,3,1,5,3,7,5,8,7,3,5,1,0].map(n=>z(t+n,.5))}}function qn(t){const e=(n,a)=>z(t+n,a);return{id:"vclimb",name:"High Five",syllable:"И-Э-А-О-У",tempo:92,kind:"jump",root:t,grooveStyle:"soft",desc:"Гибкость и точность интервала: скачки на квинту вверх и зеркально вниз.",how:"Чисто бери скачок на квинту (без зажима), пробежку пой ровно. Вторая половина — то же зеркально вниз. Опора дыханием.",notes:[e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.25),e(2,.25),e(4,.25),e(5,.25),e(7,2),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.25),e(5,.25),e(4,.25),e(2,.25),e(0,2)]}}function Dn(t){const e=(n,a,s=0)=>z(t+n,a,s);return{id:"jcharles",name:"James Charles Warm Up",syllable:"И-Э-А-О-У",tempo:130,kind:"agility",root:t,grooveStyle:"swing",desc:"Гибкость и позиция гласных: повторяющийся мотив, затем плавный спуск.",how:"Лёгко веди гласные по мотиву, в конце мягко спустись. Без зажима, позиция единая.",notes:[e(0,.5),e(2,.5),e(5,.5,.5),e(0,.5),e(2,.5),e(5,.5,.5),e(0,.5),e(2,.5),e(5,.5),e(8,1),e(7,.5),e(5,.5),e(2,.5),e(0,.5),e(2,.5),e(5,.5,.5),e(0,.5),e(2,.5),e(5,.5),e(8,1),e(7,1.5)]}}function Pn(t,e="ionian"){const n=yt([1,2,3,2,1],e);return{id:"vowels",name:"Цепочка гласных",syllable:"Ми-Ме-Ма",tempo:90,kind:"scale",root:t,modeKey:e,grooveStyle:"swing",desc:"Выравнивание гласных и сохранение позиции при смене звука.",how:"Пой по кругу гласные «Ми-Ме-Ма-Мо», широко раскрывая рот, держи единую позицию.",notes:n.map(a=>z(t+a,1))}}function Fn(t,e="ionian"){const n=yt([1,1,3,2,1,1,5,1,1,3,2,1],e);return{id:"jump5",name:"Скачок к V ступени",syllable:"Ям",tempo:100,kind:"jump",root:t,modeKey:e,grooveStyle:"latin",desc:"Точная атака интервалов и контроль регистра при скачках.",how:"Пой на «Ям». Перед скачком на квинту не зажимайся — целься точно в ноту.",notes:n.map(a=>z(t+a,1))}}function zn(t,e="ionian"){const a=yt([1,2,3,4,5,6,7,8,7,6,5,4,3,2,1],e);return{id:"lad",name:"Ладовая «ЯМ»",syllable:"Ям",tempo:100,kind:"scale",root:t,modeKey:e,drone:!0,grooveStyle:"march",desc:"Слух и ощущение ладовой окраски — гамма лада вверх и вниз.",how:"Пой на «Ям» по ступеням лада вверх до октавы и обратно. Слушай окраску лада.",notes:a.map(s=>z(t+s,1))}}function Vn(t,e=8){return{id:"sustain",name:"Удержание ноты",syllable:"А",tempo:70,kind:"sustain",root:t,grooveStyle:"ballad",desc:"Учит держать ровный стабильный звук и дыхательную опору — основа пения.",how:"Слушай образец, потом тяни ноту на «А» как можно ровнее. Держи шарик в зелёной зоне без дрожи.",notes:[z(t,e)]}}function Nn(t){return{id:"vibrato",name:"Вибрато",syllable:"А",tempo:60,kind:"vibrato",root:t,grooveStyle:"ballad",greenCents:55,yellowCents:95,desc:"Ровное вибрато — мягкое «качание» высоты примерно 5–6 раз в секунду.",how:"Сначала тяни ровную «А». Когда звук устойчив — добавь лёгкую «волну» голосом, 5–6 колебаний в секунду. Колебание идёт от дыхания и опоры, не дави горлом. На итоге увидишь частоту своего вибрато.",notes:[z(t,10)]}}function On(t){return{id:"vwobble",name:"Раскачка вибрато",syllable:"А",tempo:120,kind:"vibrato",root:t,grooveStyle:"soft",greenCents:55,desc:"Запуск вибрато: ровный звук с лёгким «качанием» высоты — основа естественного вибрато.",how:"Пой «А» и добавь мягкое колебание голосом — вверх-вниз небольшими шагами. Колебание идёт от опоры дыхания, не дави горлом.",notes:[0,1,0,1,0,1,0,5,6,5,6,5,6,5].map(n=>z(t+n,.5))}}function jn(t){return{id:"timbre",name:"Тёплый тон",syllable:"Мо",tempo:96,kind:"scale",root:t,grooveStyle:"ballad",desc:"Качество тембра: ровный, округлый звук при движении голоса по нотам.",how:"Пой «Мо» округло и тепло, держи одинаковый тембр на каждой ноте. Не зажимай, звук в маску.",notes:[0,1,3,0,1,3,1,0,0,1,3,5,7,5].map(n=>z(t+n,.5))}}function _n(t){return{id:"timbre2",name:"Ровный тон на двух",syllable:"А",tempo:80,kind:"sustain",root:t,grooveStyle:"ballad",desc:"Единый тембр при переходе между двумя высотами (вниз на кварту и обратно).",how:"Держи одинаковый округлый звук на обеих нотах — не «бели» нижнюю и не зажимай верхнюю.",notes:[0,0,0,-5,-5,0,0,-5,-5].map(n=>z(t+n,1))}}function Gn(t){return{id:"regarp",name:"Через регистры",syllable:"Но",tempo:92,kind:"jump",root:t,grooveStyle:"soft",desc:"Плавный переход (passaggio): соединяем нижний и верхний регистр через опорные тоны аккорда.",how:"Пой «Но», возвращаясь к тонике и беря всё выше (терция → квинта → октава). Без «слома» на переходе — мягко.",notes:[0,3,0,7,0,12,0,7,0,3].map(n=>z(t+n,.6))}}function Wn(t){return{id:"regoct",name:"Октавная связка",syllable:"А",tempo:76,kind:"jump",root:t,grooveStyle:"soft",desc:"Связка регистров на октаве — без резкого «переключения» голоса.",how:"Спокойно прыгай на октаву вверх и обратно, целься в центр ноты. Верх не криком, а на опоре и резонансе.",notes:[0,12,0,12].map(n=>z(t+n,1.5))}}function Un(t){return{id:"belt",name:"Белтинг — гамма",syllable:"Эй",tempo:112,kind:"scale",root:t,grooveStyle:"drive",desc:"Яркая опёртая подача (белтинг) на пятинотной гамме — мощно, но без зажима.",how:"Пой «Эй» ярко и звонко, опираясь дыханием. Звук вперёд (в маску), горло свободно. Не дави на верхних нотах.",notes:[0,1,3,5,7,5,3,1,0].map(n=>z(t+n,.6))}}function Yn(t){return{id:"beltoct",name:"Белт — октава",syllable:"Эй",tempo:100,kind:"jump",root:t,grooveStyle:"drive",desc:"Опёртая атака верхней ноты через октаву — энергично и безопасно.",how:"Бери октаву вверх ярко и точно, на опоре. Не тянись горлом — звук на дыхании и в резонаторах.",notes:[0,12,0,12,0,12,0].map(n=>z(t+n,.8))}}function Kn(t){return{id:"artic",name:"Чёткое стаккато",syllable:"Та",tempo:132,kind:"agility",root:t,grooveStyle:"funk",desc:"Чёткая артикуляция и точная атака: одна нота, быстрые ясные слоги.",how:"Пой «Та-Та-Та» коротко и чётко на одной высоте. Согласная ясная, гласная ровная, звук не «расползается».",notes:[0,0,0,0,0,0,0,0].map(n=>z(t+n,.5))}}function Jn(t){return{id:"artic2",name:"Слоги по группам",syllable:"Та-Ка",tempo:120,kind:"agility",root:t,grooveStyle:"funk",desc:"Дикция при смене высоты: чёткие слоги группами на двух нотах.",how:"Пой «Та-Ка-Та» группами, чисто меняя высоту вниз и обратно. Каждый слог ясный, ритм ровный.",notes:[0,0,0,-5,-5,-5,0,0,0,-5,-5,-5].map(n=>z(t+n,.5))}}function Xn(t){return{id:"resist",name:"Стамина-фигура",syllable:"Ма",tempo:116,kind:"agility",root:t,grooveStyle:"march",desc:"Выносливость и ровность: устойчивый мотив-«волчок» много раз без потери опоры.",how:"Пой «Ма» по фигуре вверх-вниз ровно и не уставая. Дыхание ровное, опора держится до конца.",notes:[0,1,3,1,0,1,3,1,0,1,3,1,0].map(n=>z(t+n,.5))}}function Qn(t){return{id:"resist2",name:"Выносливая гамма",syllable:"Ма",tempo:126,kind:"agility",root:t,grooveStyle:"march",desc:"Дыхательная выносливость: длинный ровный пробег по гамме без добора воздуха.",how:"Пой «Ма» по гамме вверх-вниз дважды на одном дыхании, ровно и точно. Распредели воздух до конца.",notes:[0,1,3,5,7,5,3,1,0,1,3,5,7,5,3,1,0].map(n=>z(t+n,.5))}}function Zn(t,e="ionian"){const n=yt([1,2,3,4,5,4,3,2,1],e);return{id:"scale5",name:"Гамма «Ма-Мэ»",syllable:"Ма",tempo:104,kind:"scale",root:t,modeKey:e,grooveStyle:"pop",desc:"Тренирует точность интонации — чистое попадание в каждую ступень гаммы.",how:"Пой «Ма» и попадай в каждую ноту, которая подъезжает к линии. Старайся держать зелёный.",notes:n.map(a=>z(t+a,1))}}function ts(t,e="ionian"){const n=yt([1,2,3,4,5,6,5,4,3,2,1],e);return{id:"agility",name:"Беглость «Ма»",syllable:"Ма",tempo:138,kind:"agility",root:t,modeKey:e,grooveStyle:"funk",desc:"Развивает беглость: быстрые и точные переходы между нотами (как в Vocalista).",how:"Пой «Ма» легко и быстро, попадая в каждую ноту пробегающего пассажа. Не зажимайся.",notes:n.map(a=>z(t+a,.5))}}function es(t){return{id:"jump",name:"Октавный скачок",syllable:"А",tempo:84,kind:"jump",root:t,grooveStyle:"drive",desc:"Учит координации между нижним и верхним регистром голоса.",how:"Пой «А», точно прыгая на октаву вверх и обратно вниз. Целься в центр ноты.",notes:[z(t+12,2),z(t,2),z(t+12,2),z(t,2)]}}function Se(t,e="ionian"){const n=yt([1,2,3,2,1],e);return{id:"hum3",name:"Мычание по гамме",syllable:"М",tempo:92,kind:"hum",root:t,modeKey:e,grooveStyle:"soft",desc:"Мягкая активация голоса и резонаторов на «м-м-м» — три ступеньки вверх и обратно.",how:"Сомкни губы и мычи «м», идя по нотам: вверх три ступени и вниз. Звук в маску/нос.",notes:n.map(a=>z(t+a,1))}}function Be(t,e="ionian"){const n=yt([1,2,3,4,5,4,3,2,1,5,1],e);return{id:"trill",name:"Губной тренаж «brrr»",syllable:"brrr",tempo:120,kind:"trill",root:t,modeKey:e,grooveStyle:"drive",desc:"Ровный воздушный поток и гибкость: пять ступеней вверх-вниз и скачок на квинту.",how:"Губами «brrr» (если не выходит — на «Р»). Веди по нотам ровно, в конце — скачок на квинту и тонику.",notes:n.map(a=>z(t+a,.75))}}function Us(t){return t.notes.map(e=>G(e.midi))}function Ie(t,e,n,a=4){const s=t.notes.map(u=>u.midi),i=Math.min(...s),o=Math.max(...s);if(!Number.isFinite(e)||!Number.isFinite(n))return[0];const c=Math.max(0,Math.min(a,n-o)),l=Math.max(0,Math.min(a,i-e)),r=[];for(let u=0;u<=c;u++)r.push(u);for(let u=c-1;u>=-l;u--)r.push(u);return r.length?r:[0]}function sn(t){if(t.__noise)return t.__noise;const e=t.createBuffer(1,Math.floor(t.sampleRate*.5),t.sampleRate),n=e.getChannelData(0);for(let a=0;a<n.length;a++)n[a]=Math.random()*2-1;return t.__noise=e,e}const an={pop:{kick:[0,4],snare:[2,6],hatOpen:[7],bass:[[0,0],[3,0],[4,7]],stab:[3,7],swing:0},funk:{kick:[0,3,6],snare:[2,6],hatOpen:[3,7],bass:[[0,0],[1,7],[4,0],[6,7]],stab:[1,3,5,7],swing:.18},soft:{kick:[0,4],snare:[6],hatOpen:[],bass:[[0,0],[4,7]],stab:[3],swing:0},drive:{kick:[0,2,4,6],snare:[2,6],hatOpen:[],bass:[[0,0],[2,0],[4,7],[6,7]],stab:[4],swing:0},march:{kick:[0,2,4,6],snare:[4],hatOpen:[0,4],bass:[[0,0],[2,7],[4,0],[6,7]],stab:[],swing:0},swing:{kick:[0,4],snare:[2,6],hatOpen:[3,7],bass:[[0,0],[3,5],[4,7],[6,12]],stab:[3,7],swing:.34},ballad:{kick:[0],snare:[4],hatOpen:[],bass:[[0,0],[4,7]],stab:[2,6],swing:0},latin:{kick:[0,3,6],snare:[2,7],hatOpen:[5],bass:[[0,0],[3,7],[6,5]],stab:[2,5],swing:0}};function Ys(t,{rootMidi:e=60,tempo:n=100,dur:a=16,style:s="pop",gain:i=.5,when:o=0}={}){const c=an[s]||an.pop,l=t.currentTime+o,r=60/n,u=r/2,h=r*4,v=Math.ceil(a/h)+1,d=t.createGain();d.gain.value=i;const f=t.createDynamicsCompressor();f.threshold.value=-12,f.ratio.value=4,d.connect(f).connect(t.destination);const m=[],b=p=>{const S=t.createOscillator(),k=t.createGain();S.frequency.setValueAtTime(150,p),S.frequency.exponentialRampToValueAtTime(48,p+.12),k.gain.setValueAtTime(.9,p),k.gain.exponentialRampToValueAtTime(.001,p+.18),S.connect(k).connect(d),S.start(p),S.stop(p+.2),m.push(S)},g=p=>{const S=t.createBufferSource();S.buffer=sn(t);const k=t.createBiquadFilter();k.type="bandpass",k.frequency.value=1800,k.Q.value=.7;const E=t.createGain();E.gain.setValueAtTime(.5,p),E.gain.exponentialRampToValueAtTime(.001,p+.14),S.connect(k).connect(E).connect(d),S.start(p),S.stop(p+.16),m.push(S)},y=(p,S)=>{const k=t.createBufferSource();k.buffer=sn(t);const E=t.createBiquadFilter();E.type="highpass",E.frequency.value=7e3;const H=t.createGain(),C=S?.12:.035;H.gain.setValueAtTime(.22,p),H.gain.exponentialRampToValueAtTime(.001,p+C),k.connect(E).connect(H).connect(d),k.start(p),k.stop(p+C+.02),m.push(k)},w=(p,S,k)=>{const E=t.createOscillator(),H=t.createGain();E.type="triangle",E.frequency.value=G(S),H.gain.setValueAtTime(1e-4,p),H.gain.linearRampToValueAtTime(.4,p+.01),H.gain.setValueAtTime(.4,p+k*.5),H.gain.exponentialRampToValueAtTime(.001,p+k),E.connect(H).connect(d),E.start(p),E.stop(p+k+.02),m.push(E)},A=p=>{[e,e+7,e+12].forEach(S=>{const k=t.createOscillator(),E=t.createGain();k.type="triangle",k.frequency.value=G(S),E.gain.setValueAtTime(1e-4,p),E.gain.linearRampToValueAtTime(.09,p+.008),E.gain.exponentialRampToValueAtTime(.001,p+.17),k.connect(E).connect(d),k.start(p),k.stop(p+.2),m.push(k)})},L=e-12;for(let p=0;p<v;p++){const S=l+p*h,k=E=>S+E*u+(E%2?c.swing*u:0);c.kick.forEach(E=>b(k(E))),c.snare.forEach(E=>g(k(E)));for(let E=0;E<8;E++)y(k(E),c.hatOpen.includes(E));c.bass.forEach(([E,H])=>w(k(E),L+H,u*1.6)),c.stab.forEach(E=>A(k(E)))}return{duck(p){const S=p?i*.25:i;try{d.gain.setTargetAtTime(S,t.currentTime,.04)}catch{}},stop(){try{m.forEach(p=>{try{p.stop()}catch{}p.disconnect&&p.disconnect()}),d.disconnect(),f.disconnect()}catch{}}}}const Ce="raspevka.clock.v1";function ns(){try{return Number(localStorage.getItem(Ce))||0}catch{return 0}}function ft(){return Date.now()+ns()}function ss(){return new Date(ft())}function lt(t=ss()){return t.toISOString().slice(0,10)}function as(){return Math.round(ns()/864e5)}function Ks(t){try{localStorage.setItem(Ce,String(Math.round(t)*864e5))}catch{}}function fe(t){Ks(as()+t)}function be(){try{localStorage.removeItem(Ce)}catch{}}const Ae="raspevka.progress.v1";function x(){try{return JSON.parse(localStorage.getItem(Ae))||{}}catch{return{}}}function D(t){try{localStorage.setItem(Ae,JSON.stringify(t))}catch{}}function is(){try{localStorage.removeItem(Ae)}catch{}}function Js(){const t=x();return t.range&&Number.isFinite(t.range.low)?t.range:null}function os(t){const e=x(),n=lt(),a=lt(new Date(ft()-864e5)),s=lt(new Date(ft()-2*864e5));let i=!1;return e.lastDate!==n?(e.lastDate===a?e.streak=(e.streak||0)+1:e.lastDate===s&&(e.freezes||0)>0?(e.freezes-=1,i=!0,e.streak=(e.streak||0)+1):e.streak=1,e.lastDate=n,e.streak>0&&e.streak%7===0&&(e.freezes=Math.min(2,(e.freezes||0)+1))):e.streak||(e.streak=1),e.history=e.history||[],e.history.push({date:n,pct:t.pct,stars:t.stars}),e.history.length>200&&(e.history=e.history.slice(-200)),e.total=(e.total||0)+1,D(e),{streak:e.streak,total:e.total,freezeSpent:i}}function le(){return x().streak||0}function Xt(){return x().freezes||0}function Xs(t){const e=x();return e.freezes=Math.max(0,Math.min(2,Math.round(t))),D(e),e.freezes}function Qs(){const t=lt();return(x().history||[]).some(e=>e.date===t)}function pe(t){const e=x();return e.streak=Math.max(0,Math.round(t)),e.lastDate=lt(),D(e),e.streak}function Zs(){return x().history||[]}function ta(){return x().rangeHistory||[]}function ea(){return x().total||0}function na(t){const e=x();return e.leads=e.leads||[],e.leads.push({ts:ft(),...t}),e.leads.length>50&&(e.leads=e.leads.slice(-50)),D(e),e.leads}function Ft(){return x().examsPassed||[]}function sa(t){const e=x();return e.examsPassed=e.examsPassed||[],e.examsPassed.includes(t)||(e.examsPassed.push(t),D(e)),e.examsPassed}function aa(t){return(x().blockItems||{})[t]||[]}function on(t,e){const n=x();n.blockItems=n.blockItems||{};const a=n.blockItems[t]||[];return a.includes(e)||(a.push(e),n.blockItems[t]=a,D(n)),a}function Y(){return x().modeKey||"ionian"}function cs(t){const e=x();return e.modeKey=t,D(e),t}function xt(){return x().tier||"free"}function _t(t){const e=x();return e.tier=t,D(e),t}const Mt=5,ia=25;function qt(){return Mt}function bt(){const t=x();let e=t.energy==null?Mt:t.energy;if(e<Mt&&t.energyTs){const n=Math.floor((ft()-t.energyTs)/(ia*6e4));n>0&&(e=Math.min(Mt,e+n))}return e}function Gt(t){const e=x(),n=Math.max(0,Math.min(Mt,Math.round(t)));return e.energy=n,e.energyTs=n<Mt?ft():null,D(e),n}function $e(t){return Gt(bt()+t)}function He(){return x().groove||"off"}function ls(t){const e=x();return e.groove=t,D(e),t}function oa(t){const e=x();if(!e.range||!Number.isFinite(e.range.low))return{extended:null};let n=null;return t>e.range.high?(e.range.high=t,n="high"):t<e.range.low&&(e.range.low=t,n="low"),n&&(e.rangeHistory=e.rangeHistory||[],e.rangeHistory.push({date:lt(),low:e.range.low,high:e.range.high}),e.rangeHistory.length>100&&(e.rangeHistory=e.rangeHistory.slice(-100)),D(e)),{extended:n,midi:t}}function st(){const t=x();return t.voice&&t.voice.key?t.voice:null}function cn(t,e=null,n=null){const a=x(),s=a.voice||{};return a.voice={key:t,low:e??s.low??null,high:n??s.high??null},e!=null&&n!=null&&(a.range={low:Math.round(e),high:Math.round(n)},a.rangeHistory=a.rangeHistory||[],a.rangeHistory.push({date:lt(),low:Math.round(e),high:Math.round(n)}),a.rangeHistory.length>100&&(a.rangeHistory=a.rangeHistory.slice(-100))),D(a),a.voice}const ca={easy:.6,medium:.8,fast:1};function Re(){return x().difficulty||"easy"}function rs(t){const e=x();return e.difficulty=t,D(e),t}function la(){return ca[Re()]||.6}function Lt(){return x().guide!==!1}function ds(t){const e=x();return e.guide=!!t,D(e),e.guide}function pt(){return x().headphones===!0}function us(t){const e=x();return e.headphones=!!t,D(e),e.headphones}function ra(){return Lt()?pt()?"continuous":"prehear":"off"}function gt(){const t=x().timbre;return t==="guitar"||t==="soft"?t:"piano"}function ms(t){const e=x();return e.timbre=t,D(e),e.timbre}function hs(){try{const t=navigator.userAgent||"";return/Mobi|Android|iPhone|iPad|iPod/i.test(t)||(navigator.maxTouchPoints||0)>1}catch{return!1}}const qe={quiet:1,normal:1.8,loud:2.8,max:4.2};function da(){return hs()?"loud":"normal"}function re(){const t=x().volume;return qe[t]?t:da()}function de(){return qe[re()]}function vs(t){const e=x();return qe[t]&&(e.volume=t,D(e)),re()}const De={speaker:.09,wired:.12,bt:.24};function ua(){return"speaker"}function ue(){const t=x().route;return De[t]?t:ua()}function ma(t){const e=x();return De[t]&&(e.route=t,delete e.latencyManual,D(e)),ue()}function Pe(){const t=x().latencyManual;return Number.isFinite(t)?t:De[ue()]}function ln(t){const e=x();return e.latencyManual=Math.max(0,Math.min(.5,t)),D(e),e.latencyManual}function Ct(){return x().darkStage===!0}function ha(t){const e=x();return e.darkStage=!!t,D(e),e.darkStage}function It(){return x().micAGC===!0}function va(t){const e=x();return e.micAGC=!!t,D(e),e.micAGC}const fs={low:1.5,med:3,high:5.5};function fa(){return hs()?"high":"med"}function Fe(){const t=x().sensitivity;return fs[t]?t:fa()}function ze(){return fs[Fe()]}function bs(t){const e=x();return e.sensitivity=t,D(e),t}function ps(){return x().breathBest||0}function ba(t){const e=x();return e.breathBest=Math.max(e.breathBest||0,t),D(e),e.breathBest}const Ve=5,pa=7;function Qt(){return x().paywallEnabled===!0}function ge(t){const e=x();return e.paywallEnabled=!!t,D(e),e.paywallEnabled}function gs(){const t=x();return t.trialStart||(t.trialStart=ft(),D(t)),t.trialStart}function Ne(){const t=x().trialStart;if(!t)return null;const e=pa-Math.floor((ft()-t)/864e5);return Math.max(0,e)}function ga(){const t=Ne();return t!=null&&t>0}function ya(){const t=x();delete t.trialStart,D(t)}function wa(){return xt()!=="free"||ga()}function ys(){const t=x();return t.uses&&t.uses.date===lt()?t.uses.count:0}function ws(){const t=x(),e=lt();return t.uses=t.uses&&t.uses.date===e?{date:e,count:t.uses.count+1}:{date:e,count:1},D(t),t.uses.count}function Ea(){return!Qt()||wa()?!1:ys()>=Ve}function $a(){return x().devMode===!0}function Zt(t){const e=x();return e.devMode=!!t,D(e),e.devMode}function ka(t){const e=x();return e.examsPassed=t.slice(),D(e),e.examsPassed}function xa(){const t=x();delete t.examsPassed,delete t.blockItems,D(t)}const te="raspevka.analytics.v1",rn=500;function Ma(t,e={}){try{const n=JSON.parse(localStorage.getItem(te)||"[]");n.push({t:Date.now(),type:t,...e}),n.length>rn&&n.splice(0,n.length-rn),localStorage.setItem(te,JSON.stringify(n))}catch{}}function La(){try{return JSON.parse(localStorage.getItem(te)||"[]")}catch{return[]}}function Ta(){try{localStorage.removeItem(te)}catch{}}function Sa(){const t=La(),e=t.filter(s=>s.type==="exercise_done"),n={};for(const s of e)(n[s.id||"—"]=n[s.id||"—"]||[]).push(s.pct||0);const a=Object.entries(n).map(([s,i])=>({id:s,runs:i.length,avgPct:Math.round(i.reduce((o,c)=>o+c,0)/i.length)})).sort((s,i)=>i.runs-s.runs);return{total:t.length,sessions:e.length,perEx:a}}const Ba="#0e8d7f",Ia="#0a766a",Ca="#687485",Aa="#ffffff",dn="#2a3340",Ha="#cfd6e0",Ra=[0,2,4,5,7,9,11],un=t=>Ra.includes((t%12+12)%12),qa=t=>`C${Math.floor(t/12)-1}`;function Es(t,e){if(t==null||e==null)return"";let n=Math.round(t)-2,a=Math.round(e)+2;for(;(n%12+12)%12!==0;)n--;for(;(a%12+12)%12!==11;)a++;const s=13,i=54,o=9,c=33,l=d=>d>=t&&d<=e,r=[];for(let d=n;d<=a;d++)un(d)&&r.push(d);const u=r.length*s,h={};r.forEach((d,f)=>{h[d]=f*s});let v="";r.forEach((d,f)=>{const m=f*s;v+=`<rect x="${m}" y="0" width="${s-1}" height="${i}" rx="2.5" fill="${l(d)?Ba:Aa}" stroke="${Ha}" stroke-width="1"/>`,(d%12+12)%12===0&&(v+=`<text x="${m+(s-1)/2}" y="${i+11}" text-anchor="middle" fill="${Ca}" font-size="8">${qa(d)}</text>`)});for(let d=n;d<=a;d++){if(un(d))continue;const f=h[d-1];if(f==null)continue;const m=f+s-o/2;v+=`<rect x="${m}" y="0" width="${o}" height="${c}" rx="2" fill="${l(d)?Ia:dn}" stroke="${dn}" stroke-width="1"/>`}return`
  ...
  `}function Ut(t,e,n){t.querySelectorAll("[data-diff]").forEach(o=>{o.addEventListener("click",()=>{rs(o.dataset.diff),e()})}),t.querySelectorAll("[data-timbre]").forEach(o=>{o.addEventListener("click",()=>{ms(o.dataset.timbre),e()})}),t.querySelectorAll("[data-groove]").forEach(o=>{o.addEventListener("click",()=>{ls(o.dataset.groove),e()})}),t.querySelectorAll("[data-vol]").forEach(o=>{o.addEventListener("click",()=>{if(vs(o.dataset.vol),ce(de()),n&&n.ctx)try{vt(n.ctx,523.25,.5,0,.22,gt())}catch{}e()})});const a=t.querySelector("[data-guidetoggle]");a&&a.addEventListener("click",()=>{ds(!Lt()),e()});const s=t.querySelector("[data-hptoggle]");s&&s.addEventListener("click",()=>{us(!pt()),e()});const i=t.querySelector(".more-settings");i&&i.addEventListener("toggle",()=>{$s=i.open})}function vn(t,e){if(t.stars>=3)return"Чисто и точно! Можно прибавить темп или взять упражнение посложнее.";const n=[],a=t.avgCents;a<=-18?n.push("Ты чаще занижал — тяни ноту чуть выше, поддержи дыханием (опора живота)."):a>=18&&n.push("Ты чаще завышал — не дави, расслабь гортань, целься чуть ниже.");const s=t.perNote.length;if(s>=3){const o=e.notes.map((l,r)=>({i:r,midi:l.midi})).sort((l,r)=>r.midi-l.midi).slice(0,Math.max(1,Math.round(s/3)));o.reduce((l,r)=>l+(t.perNote[r.i]||0),0)/o.length<t.pct-.15&&n.push("Верхние ноты даются хуже — не тянись вверх горлом, добавь головной резонанс и воздух.")}return n.length||n.push("Целься в центр ноты и держи ровно. Включи «подсказку тоном» — попадать заметно легче."),n.join(" ")}const J=(t,e)=>({s:t,b:e});function jt(t,e){const n=[];for(let a=0;a<e;a++)n.push(...t.map(s=>({...s})));return n}const At={air1:{id:"air1",name:"Дыхание: длинные с / ш",kind:"rhythm",tempo:70,desc:"Ровный длинный выдох на «с» и «ш» под метроном — опора и расход воздуха.",how:"«с-с-с» тянем на 4 клика → вдох носом → «ш-ш-ш» на 4 клика → вдох носом. Выдох ровный, без толчков.",steps:jt([J("с",4),J("вдох",2),J("ш",4),J("вдох",2)],4)},air2:{id:"air2",name:"Дыхание: короткий с + 5 ш",kind:"rhythm",tempo:80,desc:"Короткий толчок «с» и серия «ш» — активный выдох и чувство ритма.",how:"Короткий «с», пауза, затем 5 коротких «ш». Между «с» и «ш» НЕ дышим; вдох носом — после серии.",steps:jt([J("с",.5),J("rest",.5),J("ш",.5),J("ш",.5),J("ш",.5),J("ш",.5),J("ш",.5),J("вдох",2)],6)},air3:{id:"air3",name:"Артикуляция: 15 с + 15 ш",kind:"rhythm",tempo:80,desc:"Чёткие короткие «с» и «ш» в ровном пульсе — артикуляция и дыхание.",how:"15 коротких «с» → вдох носом → 15 коротких «ш». Держи ровный пульс с метрономом.",steps:[...jt([J("с",.5)],15),J("вдох",2),...jt([J("ш",.5)],15)]}},Va={с:"С-с-с",ш:"Ш-ш-ш",вдох:"Вдох носом",rest:"·"};function ks(t,e,n,a,{onExit:s,onComplete:i}={}){let o=null,c=null,l=!1;const r=[];function u(){o&&(cancelAnimationFrame(o),o=null),r.forEach(clearTimeout),r.length=0,c&&(c.stop(),c=null),document.removeEventListener("visibilitychange",h)}function h(){document.hidden?(o&&(cancelAnimationFrame(o),o=null),c&&(c.stop(),c=null),l=!0):l&&(l=!1,v())}function v(){u(),t.innerHTML=`
    ...
    `,document.getElementById("go").addEventListener("click",b),document.getElementById("quit").addEventListener("click",a)}function d(){const f=u.filter(L=>L&&typeof L.pct=="number"),m=f.length?f.reduce((L,p)=>L+p.pct,0)/f.length:1,b=m>=.85?3:m>=.6?2:m>=.35?1:0,{streak:g,freezeSpent:y}=os({pct:m,stars:b});zt(2),ee(30);const w="★".repeat(b)+"☆".repeat(3-b),A=Math.round(m*100);t.innerHTML=`
      <div class="screen summary">
    ...
    `,document.getElementById("menu").addEventListener("click",a)}h()}function Oe(t,e,n,{onDone:a,onExit:s,canSkip:i=!1}){let o=null;const c=()=>{o&&cancelAnimationFrame(o),o=null};function l(){c(),n.reset();const v=st(),d=v&&dt(v.key);let f=d?d.group:"муж";t.innerHTML=`
      <div class="screen">
        <div class="game-top">
    ...
    `,document.getElementById("back").addEventListener("click",s),document.getElementById("detect").addEventListener("click",r);function m(){const b=st();document.getElementById("voiceCards").innerHTML=ne.filter(g=>g.group===f).map(g=>`
          <button class="list-item voice-card" data-pick="${g.key}">
            <span class="li-main">${g.name}${b&&b.key===g.key?" ·  выбран":""}</span>
            <span class="li-sub">${g.group==="муж"?"мужской":"женский"} · ${fn(g)}</span>
          </button>`).join(""),document.querySelectorAll("[data-pick]").forEach(g=>g.addEventListener("click",()=>{cn(g.dataset.pick),a(st())}))}document.querySelectorAll("[data-gender]").forEach(b=>b.addEventListener("click",()=>{f=b.dataset.gender,document.querySelectorAll("[data-gender]").forEach(g=>g.classList.toggle("on",g.dataset.gender===f)),m()})),m()}function r(){c(),t.innerHTML=`
      <div class="screen breathe-intro">
    ...
    `,document.getElementById("back").addEventListener("click",l),document.getElementById("go").addEventListener("click",()=>u("low"))}function u(v,d=null){c();const f=v==="low";t.innerHTML=`
    ...
    `,document.getElementById("back").addEventListener("click",()=>f?r():u("low"));const m=document.getElementById("note"),b=document.getElementById("status"),g=document.getElementById("stab"),y=[],w=24,A=1200;let L=0;function p(H){const C=Math.min(...H),T=Math.max(...H);return 1200*Math.log2(T/C)}function S(H){const C=[...H].sort((T,R)=>T-R);return C[Math.floor(C.length/2)]}n.reset(),n.setRange&&n.setRange(55,1300);function k(){const H=e.read();if(H){const{smoothedHz:C,voiced:T}=n.process(H);if(T&&C){const R=rt(C),$=R.name.match(/^([A-G]#?)(-?\d+)$/);if(m.className="note-display green",m.innerHTML=$?`${$[1]}<span class="oct">${$[2]}</span>`:R.name,y.push(C),y.length>w&&y.shift(),y.length>=w&&p(y)<110){L||(L=performance.now());const q=performance.now()-L;g.style.width=Math.min(100,q/A*100)+"%";const _=Math.ceil((A-q)/1e3);if(b.textContent=q<A?`Держи… ${Math.max(1,_)}`:"Готово!",q>=A)return E(Math.round(rt(S(y)).midi))}else L=0,g.style.width="0%",b.textContent="Держи ровнее…"}else m.className="note-display silent",m.textContent="—",L=0,g.style.width="0%",y.length&&(y.length=0),b.textContent="Пой и держи ровно…"}o=requestAnimationFrame(k)}k();function E(H){if(c(),f)u("high",H);else{let C=d,T=H;T<=C&&(T=C+7),h(C,T)}}}function h(v,d){c();const f=Na(v,d);cn(f.key,v,d),zt(2),ee(25),t.innerHTML=`
      <div class="screen summary">
        ...
        <div class="card" style="text-align:left;width:100%">
          ...
          ${Es(v,d)}
          <p class="how"><b>Типичный для ${f.name.toLowerCase()}:</b> ${fn(f)}</p>
    ...
    </svg>`}function Wa(t,{onExit:e}){const n=Zs(),a=ta(),s=le(),i=ea(),o=ps(),c=st(),l=c&&dt(c.key),r=new Set(n.map(b=>b.date)),u=[];for(let b=13;b>=0;b--){const g=new Date(Date.now()-b*864e5);u.push(`<span class="cal-dot ${r.has(_a(g))?"done":""}"></span>`)}const h=n.slice(-12),v=h.length?h.map(b=>{const g=Math.round((b.pct||0)*100);return`<div class="acc-bar ${b.stars>=3?"g":b.stars===2?"a":"c"}" style="height:${Math.max(6,g)}%" title="${g}%"></div>`}).join(""):'<p class="hint">Пройди распевку — здесь появится история точности.</p>';let d="";const f=a.length?a[a.length-1]:c&&c.low!=null?c:null;if(f&&f.low!=null){const b=f.high-f.low;let g="";if(a.length>=2){const y=a[0],w=f.high-f.low-(y.high-y.low);w>0&&(g=` · <span style="color:var(--green)">+${w} пт с начала</span>`)}d=`
      <div class="card" style="text-align:left;width:100%">
        <div class="seg-label">Диапазон голоса</div>
        <p class="how" style="margin-top:6px"><b>${ot(f.low)} – ${ot(f.high)}</b> · ${b} полутонов${g}</p>
        ${Es(f.low,f.high)}
        ${Ga(a)}
  ...
  `,document.getElementById("back").addEventListener("click",()=>{C(),a()});function h(){const T=Fe();document.getElementById("sens").innerHTML=[["low","Низкая"],["med","Средняя"],["high","Высокая"]].map(([R,$])=>`<button data-sens="${R}" class="${T===R?"on":""}">${$}</button>`).join(""),document.querySelectorAll("[data-sens]").forEach(R=>R.addEventListener("click",()=>{bs(R.dataset.sens),e.setSensitivity&&e.setSensitivity(ze()),h()}))}h();const v=document.getElementById("note"),d=document.getElementById("cents"),f=document.getElementById("lvl"),m=document.getElementById("fs"),b=m.getContext("2d");function g(){const T=Math.min(window.devicePixelRatio||1,2);m.width=m.clientWidth*T,m.height=m.clientHeight*T,b.setTransform(T,0,0,T,0,0)}g(),window.addEventListener("resize",g);function y(T,R){const $=Math.max(r,Math.min(u,T)),I=Math.log2($/r)/Math.log2(u/r);return R-I*R}const w=[];n.setRange&&n.setRange(55,1300),n.reset();const A=document.getElementById("cele");let L=null,p=0,S=0,k=null;function E(T){A&&(A.innerHTML=`<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 2l2.4 6.3L21 9l-5 4.1L17.8 20 12 16.3 6.2 20 8 13.1 3 9l6.6-.7z"/></svg> ${T}`,A.hidden=!1,clearTimeout(k),k=setTimeout(()=>{A&&(A.hidden=!0)},3400))}function H(){const T=m.clientWidth,R=m.clientHeight;b.clearRect(0,0,T,R),b.font="10px Inter, sans-serif";for(let P=Math.ceil(c);P<=l;P++){const Z=y(G(P),R),tt=(P%12+12)%12===0;b.strokeStyle=tt?"rgba(27,36,48,.20)":gn(P)?"rgba(27,36,48,.08)":"rgba(27,36,48,.03)",b.lineWidth=1,b.beginPath(),b.moveTo(34,Z),b.lineTo(T,Z),b.stroke(),gn(P)&&(b.fillStyle=tt?"rgba(27,36,48,.55)":"rgba(27,36,48,.32)",b.fillText(yn(P),4,Z+3))}const $=e.read();let I=!1,q=null;if($){const P=n.process($);I=P.voiced&&e.rms()>.0025,q=P.smoothedHz}if(I&&q){const P=rt(q),Z=(P.name||"").match(/^([A-G]#?)(-?\d+)$/);v.innerHTML=Z?`${Z[1]}<span class="oct">${Z[2]}</span>`:P.name,v.classList.remove("silent"),d.textContent=`центы: ${P.cents>0?"+":""}${P.cents}`,f.style.width=Math.min(100,e.rms()*350)+"%";const tt=y(q,R);w.push(tt);const ut=Math.round(69+12*Math.log2(q/440));Math.abs(P.cents)<42?(ut===L?p++:(L=ut,p=1),p===26&&Date.now()-S>4e3&&oa(ut).extended&&(S=Date.now(),E(`Новая нота — ${yn(ut)}! Диапазон растёт.`))):(L=null,p=0)}else v.textContent="—",v.classList.add("silent"),d.textContent="центы: —",f.style.width="0%",w.push(null),L=null,p=0;for(;w.length>90;)w.shift();const _=T-28;for(let P=0;P<w.length;P++){if(w[P]==null)continue;const Z=_-(w.length-1-P)*2.4,tt=P===w.length-1;b.fillStyle=tt?"#2fab84":"rgba(47,171,132,.35)",tt&&(b.shadowColor="#2fab84",b.shadowBlur=16),b.beginPath(),b.arc(Z,w[P],tt?8:2.5,0,Math.PI*2),b.fill(),b.shadowBlur=0}o=requestAnimationFrame(H)}H();function C(){o&&cancelAnimationFrame(o),o=null,window.removeEventListener("resize",g),clearTimeout(k)}}const Ka=""+new URL("belly-breathing-B0wu-xNS.webp",import.meta.url).href;function Ja(){return`
    ...
    `,document.getElementById("quit").addEventListener("click",()=>{u(),a()});const h=document.getElementById("core"),v=document.getElementById("phase"),d=document.getElementById("count"),f=document.getElementById("cycles");s.cycles*s.phases.length;let m=0,b=0,g=performance.now();y();function y(){f.innerHTML=Array.from({length:s.cycles},(L,p)=>`<span class="dot ${p<m?"done":p===m?"now":""}"></span>`).join("")}function w(){const L=s.phases[b],p=(performance.now()-g)/1e3,S=Math.min(1,p/L.sec),k=L.from+(L.to-L.from)*Xa(S);if(h.style.transform=`scale(${k})`,v.textContent=L.label,d.textContent=Math.ceil(L.sec-p),p>=L.sec){if(b+=1,b>=s.phases.length&&(b=0,m+=1,y()),m>=s.cycles)return A();g=performance.now()}i=requestAnimationFrame(w)}i=requestAnimationFrame(w);function A(){u(),t.innerHTML=`
        <div class="screen summary">
          <div class="stars">🫁</div>
          <div class="verdict">Готово!</div>
    ...
    `,document.getElementById("quit").addEventListener("click",()=>{u(),a()});const h=document.getElementById("timer"),v=document.getElementById("phase"),d=document.getElementById("vol"),f=.012,m=.6;let b="ready",g=0,y=0;function w(){e.read();const L=e.rms();d.style.width=Math.min(100,L*400)+"%";const p=performance.now();if(b==="ready")L>f&&(b="running",g=p,y=p,v.textContent="Тяни ровно!");else if(b==="running"&&(L>f&&(y=p),h.textContent=((p-g)/1e3).toFixed(1),p-y>m*1e3))return A((y-g)/1e3);i=requestAnimationFrame(w)}i=requestAnimationFrame(w);function A(L){u(),L=Math.max(0,Math.round(L*10)/10);const p=ba(L),S=[...s.goals].reverse().find(E=>L>=E.sec),k=S?S.label[0].toUpperCase()+S.label.slice(1)+"!":"Попробуй ещё";t.innerHTML=`
        <div class="screen summary">
    ...
    </div>`;const f=document.getElementById("status"),m=document.getElementById("bigq"),b=document.getElementById("cue"),g=document.getElementById("lvl"),y=document.getElementById("score");document.getElementById("back").addEventListener("click",()=>{H(),a()}),document.getElementById("replay").addEventListener("click",w),document.getElementById("skip").addEventListener("click",()=>{L("Пропущено"),S(1300)}),n.setRange&&n.setRange(55,1300),n.reset();function w(){e.ctx&&vt(e.ctx,G(u),1.3,0,.3,d),b.textContent="Слушай…",r="wait",clearTimeout(v),v=setTimeout(()=>{r="sing",b.textContent="Теперь спой эту ноту"},1350)}function A(){o++,u=s+ti(Za),h=0,m.textContent="?",m.classList.add("silent"),f.textContent=`Раунд ${o} / 8`,w()}function L(C){m.textContent=ei(u),m.classList.remove("silent"),C&&(b.textContent=C),r="done"}function p(){c++,y.textContent=`Верно: ${c} / 8`,L("Верно! Бра-во."),m.classList.add("hit"),S(1300)}function S(C){clearTimeout(v),v=setTimeout(()=>{m.classList.remove("hit"),o>=8?k():A()},C)}function k(){H(),t.innerHTML=`
      <div class="screen summary">
  ...
  </div>`}function oi(t,{blocks:e,examsPassed:n,onExit:a,onOpenBlock:s,onSchool:i}){const o=e.filter(r=>n.includes(r.id)).length,c=e.map((r,u)=>{const h=n.includes(r.id),v=ii(u,n),d=h?"done":v?"open":"locked",f=h?"✓":v?`${u+1}`:"🔒";return`<button class="block-card ${d}" data-block="${u}" ${v?"":"disabled"}>
  ...
  `,document.getElementById("back").addEventListener("click",i),t.querySelectorAll("[data-item]").forEach(d=>d.addEventListener("click",()=>o(e,Number(d.dataset.item)))),document.getElementById("exam").addEventListener("click",()=>c(e));const v=document.getElementById("toSchool");v&&l&&v.addEventListener("click",l)}function li(){const t=["audio/webm;codecs=opus","audio/webm","audio/mp4","audio/ogg"];for(const e of t)try{if(window.MediaRecorder&&MediaRecorder.isTypeSupported(e))return e}catch{}return""}function ri(t,e,{onExit:n}){let a=null,s=[],i=null,o=null,c=0,l=!1;function r(f){const m=Math.floor(f/1e3);return`${Math.floor(m/60)}:${String(m%60).padStart(2,"0")}`}function u(){t.innerHTML=`
  ...
  `;const v=document.getElementById("back"),d=document.getElementById("play"),f=document.getElementById("cur"),m=document.getElementById("dur"),b=document.getElementById("seek"),g=document.getElementById("note"),y=document.getElementById("fs"),w=y.getContext("2d");function A(){const E=Math.min(window.devicePixelRatio||1,2);y.width=y.clientWidth*E,y.height=y.clientHeight*E,w.setTransform(E,0,0,E,0,0)}A(),window.addEventListener("resize",A),h.addEventListener("loadedmetadata",()=>{m.textContent=kn(h.duration)}),h.addEventListener("ended",()=>{d.textContent="▶ Слушать"}),d.addEventListener("click",()=>{h.paused?(h.play().catch(()=>{}),d.textContent="⏸ Пауза"):(h.pause(),d.textContent="▶ Слушать")}),v.addEventListener("click",()=>{k(),a()});function L(E,H){const C=Math.max(r,Math.min(u,E)),T=Math.log2(C/r)/Math.log2(u/r);return H-T*H}const p=[];n.setRange&&n.setRange(55,1300),n.reset();function S(){const E=y.clientWidth,H=y.clientHeight;w.clearRect(0,0,E,H),w.font="10px Inter, sans-serif";for(let I=Math.ceil(c);I<=l;I++){const q=L(G(I),H),_=(I%12+12)%12===0;w.strokeStyle=_?"rgba(27,36,48,.20)":$n(I)?"rgba(27,36,48,.08)":"rgba(27,36,48,.03)",w.lineWidth=1,w.beginPath(),w.moveTo(34,q),w.lineTo(E,q),w.stroke(),$n(I)&&(w.fillStyle=_?"rgba(27,36,48,.55)":"rgba(27,36,48,.32)",w.fillText(mi(I),4,q+3))}h.duration&&(b.style.width=Math.min(100,h.currentTime/h.duration*100)+"%",f.textContent=kn(h.currentTime));const C=e.read();let T=!1,R=null;if(C){const I=n.process(C);T=I.voiced&&e.rms()>.0025,R=I.smoothedHz}if(T&&R){const I=rt(R),q=(I.name||"").match(/^([A-G]#?)(-?\d+)$/);g.innerHTML=q?`${q[1]}<span class="oct">${q[2]}</span>`:I.name,g.classList.remove("silent"),p.push(L(R,H))}else g.textContent="—",g.classList.add("silent"),p.push(null);for(;p.length>90;)p.shift();const $=E-28;for(let I=0;I<p.length;I++){if(p[I]==null)continue;const q=$-(p.length-1-I)*2.4,_=I===p.length-1;w.fillStyle=_?"#2fab84":"rgba(47,171,132,.35)",_&&(w.shadowColor="#2fab84",w.shadowBlur=16),w.beginPath(),w.arc(q,p[I],_?8:2.5,0,Math.PI*2),w.fill(),w.shadowBlur=0}o=requestAnimationFrame(S)}S();function k(){o&&cancelAnimationFrame(o),o=null,window.removeEventListener("resize",A);try{h.pause(),h.src=""}catch{}}}async function vi(t){return!1}function fi(t,{onExit:e}){const n=st(),a=n&&dt(n.key),s=Js(),i={voiceType:a?a.name:null,range:s&&Number.isFinite(s.low)?`${ot(s.low)}–${ot(s.high)}`:null,streak:le(),blocks:Ft().length},o=[i.voiceType,i.range?`диапазон ${i.range}`:null,i.streak?`стрик ${i.streak}`:null,i.blocks?`блоков ${i.blocks}`:null].filter(Boolean).join(" · ")||"пока без данных";let c="any";function l(){t.innerHTML=`
    ...
    `,document.getElementById("lf-ok").addEventListener("click",e)}l()}function bi(t,e,{onExit:n,onVoice:a,onCalibrate:s}){let i=!1;function o(r,u,h){return`<div class="seg">${r.map(([v,d])=>`<button data-${h}="${v}" class="${u===v?"on":""}">${d}</button>`).join("")}</div>`}function c(){const r=Sa();if(!r.sessions)return"";const u=r.perEx.slice(0,6).map(h=>`<div class="an-row"><span>${h.id}</span><span>${h.runs}× · ${h.avgPct}%</span></div>`).join("");return`
      <div class="card">
  ...
  `).join(""),c=Ts.map(($,I)=>`
    ...
    </button>`).join(""),l=le(),r=st(),u=r&&dt(r.key),h=Qs(),v=ss(),d=(v.getDate()+v.getMonth())%Yt.length,f=Yt[d],m=Te(Y()).name,b=bt(),g=qt();B.innerHTML=`
  ...
  `,document.getElementById("session").addEventListener("click",()=>{const $=()=>X(()=>{it(),Oa(B,j,K,{onExit:F})});x().safetyAccepted?$():zi($)});const y=B.querySelector("[data-focus]");y&&y.addEventListener("click",()=>ie(d)),B.querySelector("[data-voice]").addEventListener("click",()=>{X(()=>Oe(B,j,K,{onDone:()=>{it(),F()},onExit:F}))}),B.querySelector("[data-dash]").addEventListener("click",()=>Wa(B,{onExit:F})),B.querySelector("[data-freesing]").addEventListener("click",()=>{X(()=>{const $=se();Ya(B,j,K,{onExit:()=>{it(),F()},lowMidi:$.low,highMidi:$.high})})}),B.querySelectorAll("[data-ex]").forEach($=>{$.addEventListener("click",()=>ie(Number($.dataset.ex)))}),B.querySelectorAll("[data-breath]").forEach($=>{$.addEventListener("click",()=>X(()=>Ms(B,j,$.dataset.breath,{onExit:F})))}),B.querySelectorAll("[data-rhythm]").forEach($=>{$.addEventListener("click",()=>ks(B,j,Dt(),At[$.dataset.rhythm],{onExit:F}))});const w=B.querySelector("[data-path]");w&&w.addEventListener("click",je);const A=B.querySelector("[data-ear]");A&&A.addEventListener("click",()=>X(()=>{it(),Ls(B,j,K,{onExit:F,root:Dt()})}));const L=B.querySelector("[data-theory]");L&&L.addEventListener("click",()=>Qa(B,{onExit:F}));const p=B.querySelector("[data-record]");p&&p.addEventListener("click",()=>X(()=>ri(B,j,{onExit:F})));const S=B.querySelector("[data-backing]");S&&S.addEventListener("click",()=>X(()=>{const $=se();hi(B,j,K,{onExit:()=>{it(),F()},lowMidi:$.low,highMidi:$.high})}));const k=B.querySelector("[data-modes]");k&&k.addEventListener("click",Pi);const E=B.querySelector("[data-settings]");E&&E.addEventListener("click",Ht);const H=B.querySelector("[data-teacher]");H&&H.addEventListener("click",()=>Vt(F)),B.querySelectorAll("[data-song]").forEach($=>{$.addEventListener("click",()=>Hs(Number($.dataset.song)))});const C=B.querySelector("[data-guide]");C&&C.addEventListener("click",Cs);const T=B.querySelector("[data-dev]");T&&T.addEventListener("click",xn);const R=B.querySelector(".home-head h1");if(R){let $=0,I=0;R.addEventListener("click",()=>{const q=Date.now();$=q-I<600?$+1:1,I=q,$>=7&&($=0,Zt(!0),xn())})}}function xn(){Q(),Bs(B,{onExit:F})}function Cs(){Q(),ki(B,{onExit:F,onSettings:Ht})}function Di(){Q(),Ei(B,{onExit:F,onTrialStarted:F,onTeacher:()=>Vt(F)})}function As(t){if(Ea()){Di();return}Qt()&&ws(),t()}function ie(t,e=!0){if(e){As(()=>Mn(t,e));return}Mn(t,e)}function oe(t){const e=se(),n=t(60),a=Math.min(...n.notes.map(c=>c.midi))-60,s=e.low-a,i=t(s),o=Ie(i,e.low,e.high,48);return{ex:i,reps:o}}function Mn(t,e){X(()=>{it();const n=i=>Yt[t].make(i),{ex:a,reps:s}=oe(n);ct(B,j,K,a,{explain:e,reps:s,rebuild:()=>oe(n).ex,onExit:F,onAgain:()=>ie(t,!1)})})}function Hs(t,e=!0){if(e){As(()=>Ln(t,e));return}Ln(t,e)}function Ln(t,e){X(()=>{const n=Ts[t].make(Dt());ct(B,j,K,n,{explain:e,reps:[0],onExit:F,onAgain:()=>Hs(t,!1)})})}function Pi(){Q(),ai(B,{onExit:F})}function je(){Q(),oi(B,{blocks:at,examsPassed:Ft(),onExit:F,onOpenBlock:Pt,onSchool:Vt})}function Pt(t){Q();const e=at[t];ci(B,{block:e,index:t,examsPassed:Ft(),doneItems:aa(e.id),onExit:je,onRunItem:Le,onExam:me,onSchool:Vt})}function Le(t,e){const n=t.items[e],a=at.indexOf(t),s=t.items[e+1],i=()=>s?Le(t,e+1):me(t);X(()=>{if(it(),n.t==="breath"){Ms(B,j,n.id,{onExit:()=>{on(t.id,n.id),i()}});return}const o=r=>Me[n.id](r,Y()),{ex:c,reps:l}=oe(o);ct(B,j,K,c,{explain:!0,reps:l,rebuild:()=>oe(o).ex,onResult:r=>{r.pct>=.5&&on(t.id,n.id)},onExit:()=>Pt(a),onAgain:()=>Le(t,e),nextLabel:s?`Дальше: ${s.name}`:"К экзамену блока",onNext:i})})}function me(t){X(()=>{it();const e=Me[t.exam.exId](Dt(),Y()),n=se(),a=Ie(e,n.low,n.high,2);ct(B,j,K,e,{explain:!0,reps:a,rebuild:()=>Me[t.exam.exId](Dt(),Y()),onComplete:s=>Fi(t,s),onExit:()=>Pt(at.indexOf(t)),onAgain:()=>me(t)})})}function Fi(t,e){Q();const n=Math.round(e.pct*100),a=e.pct>=t.exam.pass;a?sa(t.id):bt()>0&&$e(-1);const s=at.indexOf(t),i=a&&s+1<at.length,o=a?"var(--green)":"var(--coral)";B.innerHTML=`
    ...
    </div>`,document.getElementById("toBlock").addEventListener("click",()=>Pt(s)),document.getElementById("toSchool").addEventListener("click",Vt),document.getElementById("primary").addEventListener("click",()=>{a?i?Pt(s+1):je():me(t)})}function Vt(t){Q(),fi(B,{onExit:typeof t=="function"?t:F})}function Ht(){Q(),bi(B,j,{onExit:F,onVoice:()=>X(()=>Oe(B,j,K,{onDone:()=>{it(),Ht()},onExit:Ht})),onCalibrate:()=>X(()=>wi(B,j,{onExit:Ht}))})}function zi(t){Q(),B.innerHTML=`
    <div class="screen">
