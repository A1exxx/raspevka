import{m as G,c as Rt,a as Ze,f as Tn,h as rt,M as Fs,P as zs}from"./note-map-ClIaVDR2.js";class Vs{constructor(e){this.notes=Array.from({length:e},()=>({greenMs:0,scoredMs:0,activeMs:0,sumCents:0,centsMs:0})),this.g={ms:0,sumC:0,sumC2:0,reversals:0,lastC:null,lastDir:0}}record(e,n,a,s,i=null){const o=this.notes[e];if(o&&(o.activeMs+=a,!!s&&(o.scoredMs+=a,n==="green"?o.greenMs+=a:n==="yellow"&&(o.greenMs+=a*.5),i!=null&&Number.isFinite(i)))){o.sumCents+=i*a,o.centsMs+=a;const c=this.g;if(c.ms+=a,c.sumC+=i*a,c.sumC2+=i*i*a,c.lastC!=null){const l=i-c.lastC;if(Math.abs(l)>2){const r=l>0?1:-1;c.lastDir&&r!==c.lastDir&&(c.reversals+=1),c.lastDir=r}}c.lastC=i}}result(){let e=0,n=0,a=0,s=0,i=0;for(const d of this.notes)e+=d.greenMs,n+=d.activeMs,a+=d.sumCents,s+=d.centsMs,d.activeMs>0&&d.greenMs/d.activeMs>=.5&&(i+=1);const o=n>0?e/n:0,c=o>=.85?3:o>=.6?2:o>=.35?1:0,l=this.g;let r=0;if(l.ms>0){const d=l.sumC/l.ms,b=Math.max(0,l.sumC2/l.ms-d*d);r=Math.sqrt(b)}const u=l.ms/1e3,h=u>0?l.reversals/2/u:0,v=h>=3.5&&h<=8.5&&r>=15&&r<=130;return{pct:o,stars:c,notesHit:i,notesTotal:this.notes.length,avgCents:s>0?a/s:0,perNote:this.notes.map(d=>d.activeMs>0?d.greenMs/d.activeMs:0),stability:r,vibrato:{present:v,rateHz:h}}}}const tn={light:{grid:"rgba(27,36,48,.07)",gridC:"rgba(27,36,48,.18)",label:"rgba(27,36,48,.42)",hitLine:"rgba(14,141,127,.6)",note:"rgba(14,141,127,.26)",noteActive:"rgba(14,141,127,.95)",noteGlow:"rgba(14,141,127,.5)",green:"#2fab84",yellow:"#e0a64a",red:"#e0544b",free:"#0e8d7f",glow:0},dark:{grid:"rgba(255,255,255,.055)",gridC:"rgba(255,255,255,.14)",label:"rgba(255,255,255,.45)",hitLine:"rgba(61,229,201,.7)",note:"rgba(61,229,201,.2)",noteActive:"rgba(61,229,201,.95)",noteGlow:"rgba(61,229,201,.85)",green:"#3ee6a8",yellow:"#ffc24d",red:"#ff6b61",free:"#3de5c9",glow:10}};class Ns{constructor(e,n,a={}){this.theme=tn[a.theme]||tn.light,this.canvas=e,this.ctx=e.getContext("2d"),this.ex=n,this.secPerBeat=60/(n.tempo||90),this.greenCents=n.greenCents||20,this.yellowCents=n.yellowCents||40,this.pxPerSec=a.pxPerSec||150,this.hitFrac=a.hitFrac??.26,this.leadIn=a.leadIn??2.2;let s=this.leadIn;this.timed=n.notes.map(o=>{const c=o.beats*this.secPerBeat,l={midi:o.midi,hz:G(o.midi),start:s,end:s+c,dur:c};return s+=c+(o.gap||0)*this.secPerBeat,l}),this.totalTime=s+.6;const i=n.notes.map(o=>o.midi);this.minMidi=Math.min(...i)-3,this.maxMidi=Math.max(...i)+3,this.trail=[]}yFor(e,n){const a=G(this.minMidi),s=G(this.maxMidi),i=Math.max(a,Math.min(s,e)),o=Math.log2(i/a)/Math.log2(s/a);return n-o*n}activeAt(e){for(let n=0;n<this.timed.length;n++)if(e>=this.timed[n].start&&e<this.timed[n].end)return{index:n,seg:this.timed[n]};return null}evaluate(e,n,a){const s=this.activeAt(e);if(!s)return{index:-1,zone:null,voiced:!1};if(!a||!n)return{index:s.index,zone:"red",voiced:!1};const i=Math.abs(Rt(n,s.seg.hz));return{index:s.index,zone:Ze(i,this.greenCents,this.yellowCents),voiced:!0}}draw(e,n,a){const s=this.ctx,i=this.canvas.clientWidth,o=this.canvas.clientHeight,c=i*this.hitFrac;s.clearRect(0,0,i,o);const l=this.theme;for(let g=Math.ceil(this.minMidi);g<=this.maxMidi;g++){const y=this.yFor(G(g),o),w=Tn(g),A=w&&w.startsWith("C");s.strokeStyle=A?l.gridC:l.grid,s.lineWidth=1,s.beginPath(),s.moveTo(0,y),s.lineTo(i,y),s.stroke(),A&&(s.fillStyle=l.label,s.font="10px Inter, sans-serif",s.fillText(w,4,y-3))}s.strokeStyle=l.hitLine,s.lineWidth=2,s.setLineDash([5,6]),s.beginPath(),s.moveTo(c,0),s.lineTo(c,o),s.stroke(),s.setLineDash([]);const r=this.activeAt(e),u=r?r.index:-1,h=16;for(let g=0;g<this.timed.length;g++){const y=this.timed[g],w=c+(y.start-e)*this.pxPerSec,A=y.dur*this.pxPerSec;if(w+A<-20||w>i+20)continue;const L=this.yFor(y.hz,o),p=g===u,S=8;s.fillStyle=p?l.noteActive:l.note,Os(s,w,L-h/2,Math.max(A,10),h,S),s.fill(),p&&(s.shadowColor=l.noteGlow,s.shadowBlur=18+l.glow,s.fill(),s.shadowBlur=0)}let v=null,d="#5e6b7a";if(a&&n)if(v=this.yFor(n,o),r){const g=Ze(Math.abs(Rt(n,r.seg.hz)),this.greenCents,this.yellowCents);d=g==="green"?l.green:g==="yellow"?l.yellow:l.red}else d=l.free;for(this.trail.push(v);this.trail.length>70;)this.trail.shift();const b=this.trail.length,m=2.2;s.strokeStyle=d,s.lineWidth=3,s.lineJoin="round",s.globalAlpha=.45,l.glow&&(s.shadowColor=d,s.shadowBlur=l.glow),s.beginPath();let f=!1;for(let g=0;g<b;g++){const y=this.trail[g];if(y==null){f=!1;continue}const w=c-(b-1-g)*m;f?s.lineTo(w,y):(s.moveTo(w,y),f=!0)}s.stroke(),s.shadowBlur=0;for(let g=0;g<b;g++){const y=this.trail[g];if(y==null)continue;const w=c-(b-1-g)*m;s.globalAlpha=.12+g/b*.5,s.fillStyle=d,s.beginPath(),s.arc(w,y,2,0,Math.PI*2),s.fill()}s.globalAlpha=1,v!=null&&(s.fillStyle=d,s.shadowColor=d,s.shadowBlur=16,s.beginPath(),s.arc(c,v,7,0,Math.PI*2),s.fill(),s.shadowBlur=0)}}function Os(t,e,n,a,s,i){const o=Math.min(i,s/2,a/2);t.beginPath(),t.moveTo(e+o,n),t.arcTo(e+a,n,e+a,n+s,o),t.arcTo(e+a,n+s,e,n+s,o),t.arcTo(e,n+s,e,n,o),t.arcTo(e,n,e+a,n,o),t.closePath()}const js=(()=>{try{return/Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||(navigator.maxTouchPoints||0)>1}catch{return!1}})(),_s=js?2.8:1.8;let Sn=_s,kt=null;function ce(t){if(!(!Number.isFinite(t)||t<=0)&&(Sn=t,kt&&kt.__rtGain))try{kt.__rtGain.gain.setTargetAtTime(t,kt.currentTime,.02)}catch{}}function Bn(t){if(t.__rtMaster)return kt=t,t.__rtMaster;const e=t.createDynamicsCompressor();e.threshold.value=-10,e.knee.value=24,e.ratio.value=4,e.attack.value=.003,e.release.value=.25;const n=t.createGain();return n.gain.value=Sn,e.connect(n).connect(t.destination),t.__rtMaster=e,t.__rtGain=n,kt=t,e}function vt(t,e,n=.6,a=0,s=.22,i="piano"){const o=t.currentTime+a,c=t.createGain();c.connect(Bn(t));const l=[];let r=n;const u=(h,v,d,b)=>{const m=t.createOscillator(),f=t.createGain();m.type=h,m.frequency.value=v,f.gain.value=d,m.connect(f).connect(b),m.start(o),m.stop(o+r+.08),l.push(m)};if(i==="piano")r=Math.max(1.6,n),c.gain.setValueAtTime(1e-4,o),c.gain.linearRampToValueAtTime(s,o+.008),c.gain.exponentialRampToValueAtTime(1e-4,o+r),[[1,1],[2,.5],[3,.25],[4,.12]].forEach(([h,v])=>u("sine",e*h,v,c));else if(i==="guitar"){r=Math.max(1.3,n);const h=t.createBiquadFilter();h.type="lowpass",h.frequency.setValueAtTime(3800,o),h.frequency.exponentialRampToValueAtTime(700,o+r),h.connect(c),c.gain.setValueAtTime(1e-4,o),c.gain.linearRampToValueAtTime(s,o+.006),c.gain.exponentialRampToValueAtTime(1e-4,o+r),[[1,1],[2,.32]].forEach(([v,d])=>u("sawtooth",e*v,d,h))}else r=Math.max(.2,n),c.gain.setValueAtTime(0,o),c.gain.linearRampToValueAtTime(s,o+.025),c.gain.setValueAtTime(s,o+Math.max(.05,r-.1)),c.gain.linearRampToValueAtTime(0,o+r),u("triangle",e,1,c),u("triangle",e*2,.18,c);return{dur:n,stop(){try{l.forEach(h=>{h.stop(),h.disconnect()}),c.disconnect()}catch{}}}}function en(t,e,n=0,a=1.4,s=.14,i="piano"){return[0,4,7].forEach(o=>{const c=440*Math.pow(2,(e+o-69)/12);vt(t,c,a,n,s,i)}),a}function Gs(t,e,n=.42,a="piano"){return e.forEach((s,i)=>vt(t,s,n*.9,i*n,.22,a)),e.length*n}function Kt(t,e=0,n=!1){const a=t.currentTime+e,s=t.createOscillator(),i=t.createGain();s.frequency.value=n?1600:1050;const o=n?.4:.26;i.gain.setValueAtTime(1e-4,a),i.gain.exponentialRampToValueAtTime(o,a+.005),i.gain.exponentialRampToValueAtTime(1e-4,a+.08),s.connect(i).connect(Bn(t)),s.start(a),s.stop(a+.1)}function In(t,e,n,a=.05){const s=[0,7,12].map(i=>{const o=440*Math.pow(2,(e+i-69)/12);return vt(t,o,n,0,a,"soft")});return{stop(){try{s.forEach(i=>i.stop())}catch{}}}}const Jt=[{key:"ionian",name:"Ионийский (мажор)",intervals:[0,2,4,5,7,9,11],tier:"free"},{key:"aeolian",name:"Эолийский (минор)",intervals:[0,2,3,5,7,8,10],tier:"standard"},{key:"dorian",name:"Дорийский",intervals:[0,2,3,5,7,9,10],tier:"pro"},{key:"phrygian",name:"Фригийский",intervals:[0,1,3,5,7,8,10],tier:"pro"},{key:"lydian",name:"Лидийский",intervals:[0,2,4,6,7,9,11],tier:"pro"},{key:"mixolydian",name:"Миксолидийский",intervals:[0,2,4,5,7,9,10],tier:"pro"},{key:"locrian",name:"Локрийский",intervals:[0,1,3,5,6,8,10],tier:"pro"},{key:"harm_major",name:"Гармонический мажор",intervals:[0,2,4,5,7,8,11],tier:"pro"},{key:"harm_minor",name:"Гармонический минор",intervals:[0,2,3,5,7,8,11],tier:"pro"}],nn={free:0,standard:1,pro:2};function Te(t){return Jt.find(e=>e.key===t)||Jt[0]}function Cn(t,e="free"){const n=Te(t);return nn[n.tier]<=nn[e||"free"]}function Ws(t,e){const n=e.intervals,a=Math.round(t)-1,s=Math.floor(a/7),i=(a%7+7)%7;return n[i]+12*s}function yt(t,e){const n=Te(e);return t.map(a=>Ws(a,n))}const z=(t,e=1,n=0)=>n?{midi:t,beats:e,gap:n}:{midi:t,beats:e};function An(t){const e=(n,a,s=0)=>z(t+n,a,s);return{id:"vhold",name:"Calm Down Vowels",syllable:"И-Э-А-О-У",tempo:78,kind:"vowel",root:t,grooveStyle:"soft",greenCents:25,desc:"Унификация гласных: держим позицию, меняем только гласную «И-Э-А-О-У».",how:"Пой «И-Э-А-О-У» ровно, без «прыжков» голосом при смене гласной. Сначала стаккато с паузами, потом строка повторяется выше — позиция единая.",notes:[e(0,.5,.5),e(0,.5,.5),e(0,.5,.5),e(0,.5,.5),e(0,.5,.5),e(0,.5),e(0,.5),e(0,.5),e(0,.5),e(0,1),e(4,.25),e(4,.25),e(4,.25),e(4,.25),e(4,1,2),e(4,.25),e(4,.25),e(4,.25),e(4,.25),e(4,1)]}}function Hn(t){const e=(n,a)=>z(t+n,a);return{id:"vscale",name:"Disco Vowels",syllable:"И-Э-А-О-У",tempo:124,kind:"scale",root:t,grooveStyle:"pop",desc:"Точность высоты при смене гласной — каждая гласная ведёт по двум нотам.",how:"Пой «И-Э-А-О-У» легко и точно, попадая в каждую ноту слига. Не зажимайся.",notes:[e(0,.5),e(2,.5),e(5,.5),e(7,.5),e(9,.5),e(7,.5),e(5,.5),e(2,.5),e(7,1),e(5,3)]}}function Rn(t){return{id:"vagil",name:"No Bubble Gum",syllable:"И-Э-И-А-И-О-И-У",tempo:100,kind:"agility",root:t,grooveStyle:"funk",desc:"Беглость и точность: зигзаг по ступеням вверх и обратно.",how:"Лёгко и быстро веди голос по нотам зигзагом вверх, не зажимаясь. Гласные чёткие.",notes:[0,3,1,5,3,7,5,8,7,3,5,1,0].map(n=>z(t+n,.5))}}function qn(t){const e=(n,a)=>z(t+n,a);return{id:"vclimb",name:"High Five",syllable:"И-Э-А-О-У",tempo:92,kind:"jump",root:t,grooveStyle:"soft",desc:"Гибкость и точность интервала: скачки на квинту вверх и зеркально вниз.",how:"Чисто бери скачок на квинту (без зажима), пробежку пой ровно. Вторая половина — то же зеркально вниз. Опора дыханием.",notes:[e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.25),e(2,.25),e(4,.25),e(5,.25),e(7,2),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.5),e(0,.5),e(7,.25),e(5,.25),e(4,.25),e(2,.25),e(0,2)]}}function Dn(t){const e=(n,a,s=0)=>z(t+n,a,s);return{id:"jcharles",name:"James Charles Warm Up",syllable:"И-Э-А-О-У",tempo:130,kind:"agility",root:t,grooveStyle:"swing",desc:"Гибкость и позиция гласных: повторяющийся мотив, затем плавный спуск.",how:"Лёгко веди гласные по мотиву, в конце мягко спустись. Без зажима, позиция единая.",notes:[e(0,.5),e(2,.5),e(5,.5,.5),e(0,.5),e(2,.5),e(5,.5,.5),e(0,.5),e(2,.5),e(5,.5),e(8,1),e(7,.5),e(5,.5),e(2,.5),e(0,.5),e(2,.5),e(5,.5,.5),e(0,.5),e(2,.5),e(5,.5),e(8,1),e(7,1.5)]}}function Pn(t,e="ionian"){const n=yt([1,2,3,2,1],e);return{id:"vowels",name:"Цепочка гласных",syllable:"Ми-Ме-Ма",tempo:90,kind:"scale",root:t,modeKey:e,grooveStyle:"swing",desc:"Выравнивание гласных и сохранение позиции при смене звука.",how:"Пой по кругу гласные «Ми-Ме-Ма-Мо», широко раскрывая рот, держи единую позицию.",notes:n.map(a=>z(t+a,1))}}function Fn(t,e="ionian"){const n=yt([1,1,3,2,1,1,5,1,1,3,2,1],e);return{id:"jump5",name:"Скачок к V ступени",syllable:"Ям",tempo:100,kind:"jump",root:t,modeKey:e,grooveStyle:"latin",desc:"Точная атака интервалов и контроль регистра при скачках.",how:"Пой на «Ям». Перед скачком на квинту не зажимайся — целься точно в ноту.",notes:n.map(a=>z(t+a,1))}}function zn(t,e="ionian"){const a=yt([1,2,3,4,5,6,7,8,7,6,5,4,3,2,1],e);return{id:"lad",name:"Ладовая «ЯМ»",syllable:"Ям",tempo:100,kind:"scale",root:t,modeKey:e,drone:!0,grooveStyle:"march",desc:"Слух и ощущение ладовой окраски — гамма лада вверх и вниз.",how:"Пой на «Ям» по ступеням лада вверх до октавы и обратно. Слушай окраску лада.",notes:a.map(s=>z(t+s,1))}}function Vn(t,e=8){return{id:"sustain",name:"Удержание ноты",syllable:"А",tempo:70,kind:"sustain",root:t,grooveStyle:"ballad",desc:"Учит держать ровный стабильный звук и дыхательную опору — основа пения.",how:"Слушай образец, потом тяни ноту на «А» как можно ровнее. Держи шарик в зелёной зоне без дрожи.",notes:[z(t,e)]}}function Nn(t){return{id:"vibrato",name:"Вибрато",syllable:"А",tempo:60,kind:"vibrato",root:t,grooveStyle:"ballad",greenCents:55,yellowCents:95,desc:"Ровное вибрато — мягкое «качание» высоты примерно 5–6 раз в секунду.",how:"Сначала тяни ровную «А». Когда звук устойчив — добавь лёгкую «волну» голосом, 5–6 колебаний в секунду. Колебание идёт от дыхания и опоры, не дави горлом. На итоге увидишь частоту своего вибрато.",notes:[z(t,10)]}}function On(t){return{id:"vwobble",name:"Раскачка вибрато",syllable:"А",tempo:120,kind:"vibrato",root:t,grooveStyle:"soft",greenCents:55,desc:"Запуск вибрато: ровный звук с лёгким «качанием» высоты — основа естественного вибрато.",how:"Пой «А» и добавь мягкое колебание голосом — вверх-вниз небольшими шагами. Колебание идёт от опоры дыхания, не дави горлом.",notes:[0,1,0,1,0,1,0,5,6,5,6,5,6,5].map(n=>z(t+n,.5))}}function jn(t){return{id:"timbre",name:"Тёплый тон",syllable:"Мо",tempo:96,kind:"scale",root:t,grooveStyle:"ballad",desc:"Качество тембра: ровный, округлый звук при движении голоса по нотам.",how:"Пой «Мо» округло и тепло, держи одинаковый тембр на каждой ноте. Не зажимай, звук в маску.",notes:[0,1,3,0,1,3,1,0,0,1,3,5,7,5].map(n=>z(t+n,.5))}}function _n(t){return{id:"timbre2",name:"Ровный тон на двух",syllable:"А",tempo:80,kind:"sustain",root:t,grooveStyle:"ballad",desc:"Единый тембр при переходе между двумя высотами (вниз на кварту и обратно).",how:"Держи одинаковый округлый звук на обеих нотах — не «бели» нижнюю и не зажимай верхнюю.",notes:[0,0,0,-5,-5,0,0,-5,-5].map(n=>z(t+n,1))}}function Gn(t){return{id:"regarp",name:"Через регистры",syllable:"Но",tempo:92,kind:"jump",root:t,grooveStyle:"soft",desc:"Плавный переход (passaggio): соединяем нижний и верхний регистр через опорные тоны аккорда.",how:"Пой «Но», возвращаясь к тонике и беря всё выше (терция → квинта → октава). Без «слома» на переходе — мягко.",notes:[0,3,0,7,0,12,0,7,0,3].map(n=>z(t+n,.6))}}function Wn(t){return{id:"regoct",name:"Октавная связка",syllable:"А",tempo:76,kind:"jump",root:t,grooveStyle:"soft",desc:"Связка регистров на октаве — без резкого «переключения» голоса.",how:"Спокойно прыгай на октаву вверх и обратно, целься в центр ноты. Верх не криком, а на опоре и резонансе.",notes:[0,12,0,12].map(n=>z(t+n,1.5))}}function Un(t){return{id:"belt",name:"Белтинг — гамма",syllable:"Эй",tempo:112,kind:"scale",root:t,grooveStyle:"drive",desc:"Яркая опёртая подача (белтинг) на пятинотной гамме — мощно, но без зажима.",how:"Пой «Эй» ярко и звонко, опираясь дыханием. Звук вперёд (в маску), горло свободно. Не дави на верхних нотах.",notes:[0,1,3,5,7,5,3,1,0].map(n=>z(t+n,.6))}}function Yn(t){return{id:"beltoct",name:"Белт — октава",syllable:"Эй",tempo:100,kind:"jump",root:t,grooveStyle:"drive",desc:"Опёртая атака верхней ноты через октаву — энергично и безопасно.",how:"Бери октаву вверх ярко и точно, на опоре. Не тянись горлом — звук на дыхании и в резонаторах.",notes:[0,12,0,12,0,12,0].map(n=>z(t+n,.8))}}function Kn(t){return{id:"artic",name:"Чёткое стаккато",syllable:"Та",tempo:132,kind:"agility",root:t,grooveStyle:"funk",desc:"Чёткая артикуляция и точная атака: одна нота, быстрые ясные слоги.",how:"Пой «Та-Та-Та» коротко и чётко на одной высоте. Согласная ясная, гласная ровная, звук не «расползается».",notes:[0,0,0,0,0,0,0,0].map(n=>z(t+n,.5))}}function Jn(t){return{id:"artic2",name:"Слоги по группам",syllable:"Та-Ка",tempo:120,kind:"agility",root:t,grooveStyle:"funk",desc:"Дикция при смене высоты: чёткие слоги группами на двух нотах.",how:"Пой «Та-Ка-Та» группами, чисто меняя высоту вниз и обратно. Каждый слог ясный, ритм ровный.",notes:[0,0,0,-5,-5,-5,0,0,0,-5,-5,-5].map(n=>z(t+n,.5))}}function Xn(t){return{id:"resist",name:"Стамина-фигура",syllable:"Ма",tempo:116,kind:"agility",root:t,grooveStyle:"march",desc:"Выносливость и ровность: устойчивый мотив-«волчок» много раз без потери опоры.",how:"Пой «Ма» по фигуре вверх-вниз ровно и не уставая. Дыхание ровное, опора держится до конца.",notes:[0,1,3,1,0,1,3,1,0,1,3,1,0].map(n=>z(t+n,.5))}}function Qn(t){return{id:"resist2",name:"Выносливая гамма",syllable:"Ма",tempo:126,kind:"agility",root:t,grooveStyle:"march",desc:"Дыхательная выносливость: длинный ровный пробег по гамме без добора воздуха.",how:"Пой «Ма» по гамме вверх-вниз дважды на одном дыхании, ровно и точно. Распредели воздух до конца.",notes:[0,1,3,5,7,5,3,1,0,1,3,5,7,5,3,1,0].map(n=>z(t+n,.5))}}function Zn(t,e="ionian"){const n=yt([1,2,3,4,5,4,3,2,1],e);return{id:"scale5",name:"Гамма «Ма-Мэ»",syllable:"Ма",tempo:104,kind:"scale",root:t,modeKey:e,grooveStyle:"pop",desc:"Тренирует точность интонации — чистое попадание в каждую ступень гаммы.",how:"Пой «Ма» и попадай в каждую ноту, которая подъезжает к линии. Старайся держать зелёный.",notes:n.map(a=>z(t+a,1))}}function ts(t,e="ionian"){const n=yt([1,2,3,4,5,6,5,4,3,2,1],e);return{id:"agility",name:"Беглость «Ма»",syllable:"Ма",tempo:138,kind:"agility",root:t,modeKey:e,grooveStyle:"funk",desc:"Развивает беглость: быстрые и точные переходы между нотами (как в Vocalista).",how:"Пой «Ма» легко и быстро, попадая в каждую ноту пробегающего пассажа. Не зажимайся.",notes:n.map(a=>z(t+a,.5))}}function es(t){return{id:"jump",name:"Октавный скачок",syllable:"А",tempo:84,kind:"jump",root:t,grooveStyle:"drive",desc:"Учит координации между нижним и верхним регистром голоса.",how:"Пой «А», точно прыгая на октаву вверх и обратно вниз. Целься в центр ноты.",notes:[z(t+12,2),z(t,2),z(t+12,2),z(t,2)]}}function Se(t,e="ionian"){const n=yt([1,2,3,2,1],e);return{id:"hum3",name:"Мычание по гамме",syllable:"М",tempo:92,kind:"hum",root:t,modeKey:e,grooveStyle:"soft",desc:"Мягкая активация голоса и резонаторов на «м-м-м» — три ступеньки вверх и обратно.",how:"Сомкни губы и мычи «м», идя по нотам: вверх три ступени и вниз. Звук в маску/нос.",notes:n.map(a=>z(t+a,1))}}function Be(t,e="ionian"){const n=yt([1,2,3,4,5,4,3,2,1,5,1],e);return{id:"trill",name:"Губной тренаж «brrr»",syllable:"brrr",tempo:120,kind:"trill",root:t,modeKey:e,grooveStyle:"drive",desc:"Ровный воздушный поток и гибкость: пять ступеней вверх-вниз и скачок на квинту.",how:"Губами «brrr» (если не выходит — на «Р»). Веди по нотам ровно, в конце — скачок на квинту и тонику.",notes:n.map(a=>z(t+a,.75))}}function Us(t){return t.notes.map(e=>G(e.midi))}function Ie(t,e,n,a=4){const s=t.notes.map(u=>u.midi),i=Math.min(...s),o=Math.max(...s);if(!Number.isFinite(e)||!Number.isFinite(n))return[0];const c=Math.max(0,Math.min(a,n-o)),l=Math.max(0,Math.min(a,i-e)),r=[];for(let u=0;u<=c;u++)r.push(u);for(let u=c-1;u>=-l;u--)r.push(u);return r.length?r:[0]}function sn(t){if(t.__noise)return t.__noise;const e=t.createBuffer(1,Math.floor(t.sampleRate*.5),t.sampleRate),n=e.getChannelData(0);for(let a=0;a<n.length;a++)n[a]=Math.random()*2-1;return t.__noise=e,e}const an={pop:{kick:[0,4],snare:[2,6],hatOpen:[7],bass:[[0,0],[3,0],[4,7]],stab:[3,7],swing:0},funk:{kick:[0,3,6],snare:[2,6],hatOpen:[3,7],bass:[[0,0],[1,7],[4,0],[6,7]],stab:[1,3,5,7],swing:.18},soft:{kick:[0,4],snare:[6],hatOpen:[],bass:[[0,0],[4,7]],stab:[3],swing:0},drive:{kick:[0,2,4,6],snare:[2,6],hatOpen:[],bass:[[0,0],[2,0],[4,7],[6,7]],stab:[4],swing:0},march:{kick:[0,2,4,6],snare:[4],hatOpen:[0,4],bass:[[0,0],[2,7],[4,0],[6,7]],stab:[],swing:0},swing:{kick:[0,4],snare:[2,6],hatOpen:[3,7],bass:[[0,0],[3,5],[4,7],[6,12]],stab:[3,7],swing:.34},ballad:{kick:[0],snare:[4],hatOpen:[],bass:[[0,0],[4,7]],stab:[2,6],swing:0},latin:{kick:[0,3,6],snare:[2,7],hatOpen:[5],bass:[[0,0],[3,7],[6,5]],stab:[2,5],swing:0}};function Ys(t,{rootMidi:e=60,tempo:n=100,dur:a=16,style:s="pop",gain:i=.5,when:o=0}={}){const c=an[s]||an.pop,l=t.currentTime+o,r=60/n,u=r/2,h=r*4,v=Math.ceil(a/h)+1,d=t.createGain();d.gain.value=i;const b=t.createDynamicsCompressor();b.threshold.value=-12,b.ratio.value=4,d.connect(b).connect(t.destination);const m=[],f=p=>{const S=t.createOscillator(),k=t.createGain();S.frequency.setValueAtTime(150,p),S.frequency.exponentialRampToValueAtTime(48,p+.12),k.gain.setValueAtTime(.9,p),k.gain.exponentialRampToValueAtTime(.001,p+.18),S.connect(k).connect(d),S.start(p),S.stop(p+.2),m.push(S)},g=p=>{const S=t.createBufferSource();S.buffer=sn(t);const k=t.createBiquadFilter();k.type="bandpass",k.frequency.value=1800,k.Q.value=.7;const E=t.createGain();E.gain.setValueAtTime(.5,p),E.gain.exponentialRampToValueAtTime(.001,p+.14),S.connect(k).connect(E).connect(d),S.start(p),S.stop(p+.16),m.push(S)},y=(p,S)=>{const k=t.createBufferSource();k.buffer=sn(t);const E=t.createBiquadFilter();E.type="highpass",E.frequency.value=7e3;const H=t.createGain(),C=S?.12:.035;H.gain.setValueAtTime(.22,p),H.gain.exponentialRampToValueAtTime(.001,p+C),k.connect(E).connect(H).connect(d),k.start(p),k.stop(p+C+.02),m.push(k)},w=(p,S,k)=>{const E=t.createOscillator(),H=t.createGain();E.type="triangle",E.frequency.value=G(S),H.gain.setValueAtTime(1e-4,p),H.gain.linearRampToValueAtTime(.4,p+.01),H.gain.setValueAtTime(.4,p+k*.5),H.gain.exponentialRampToValueAtTime(.001,p+k),E.connect(H).connect(d),E.start(p),E.stop(p+k+.02),m.push(E)},A=p=>{[e,e+7,e+12].forEach(S=>{const k=t.createOscillator(),E=t.createGain();k.type="triangle",k.frequency.value=G(S),E.gain.setValueAtTime(1e-4,p),E.gain.linearRampToValueAtTime(.09,p+.008),E.gain.exponentialRampToValueAtTime(.001,p+.17),k.connect(E).connect(d),k.start(p),k.stop(p+.2),m.push(k)})},L=e-12;for(let p=0;p<v;p++){const S=l+p*h,k=E=>S+E*u+(E%2?c.swing*u:0);c.kick.forEach(E=>f(k(E))),c.snare.forEach(E=>g(k(E)));for(let E=0;E<8;E++)y(k(E),c.hatOpen.includes(E));c.bass.forEach(([E,H])=>w(k(E),L+H,u*1.6)),c.stab.forEach(E=>A(k(E)))}return{duck(p){const S=p?i*.25:i;try{d.gain.setTargetAtTime(S,t.currentTime,.04)}catch{}},stop(){try{m.forEach(p=>{try{p.stop()}catch{}p.disconnect&&p.disconnect()}),d.disconnect(),b.disconnect()}catch{}}}}const Ce="raspevka.clock.v1";function ns(){try{return Number(localStorage.getItem(Ce))||0}catch{return 0}}function bt(){return Date.now()+ns()}function ss(){return new Date(bt())}function lt(t=ss()){return t.toISOString().slice(0,10)}function as(){return Math.round(ns()/864e5)}function Ks(t){try{localStorage.setItem(Ce,String(Math.round(t)*864e5))}catch{}}function be(t){Ks(as()+t)}function fe(){try{localStorage.removeItem(Ce)}catch{}}const Ae="raspevka.progress.v1";function x(){try{return JSON.parse(localStorage.getItem(Ae))||{}}catch{return{}}}function D(t){try{localStorage.setItem(Ae,JSON.stringify(t))}catch{}}function is(){try{localStorage.removeItem(Ae)}catch{}}function Js(){const t=x();return t.range&&Number.isFinite(t.range.low)?t.range:null}function os(t){const e=x(),n=lt(),a=lt(new Date(bt()-864e5)),s=lt(new Date(bt()-2*864e5));let i=!1;return e.lastDate!==n?(e.lastDate===a?e.streak=(e.streak||0)+1:e.lastDate===s&&(e.freezes||0)>0?(e.freezes-=1,i=!0,e.streak=(e.streak||0)+1):e.streak=1,e.lastDate=n,e.streak>0&&e.streak%7===0&&(e.freezes=Math.min(2,(e.freezes||0)+1))):e.streak||(e.streak=1),e.history=e.history||[],e.history.push({date:n,pct:t.pct,stars:t.stars}),e.history.length>200&&(e.history=e.history.slice(-200)),e.total=(e.total||0)+1,D(e),{streak:e.streak,total:e.total,freezeSpent:i}}function le(){return x().streak||0}function Xt(){return x().freezes||0}function Xs(t){const e=x();return e.freezes=Math.max(0,Math.min(2,Math.round(t))),D(e),e.freezes}function Qs(){const t=lt();return(x().history||[]).some(e=>e.date===t)}function pe(t){const e=x();return e.streak=Math.max(0,Math.round(t)),e.lastDate=lt(),D(e),e.streak}function Zs(){return x().history||[]}function ta(){return x().rangeHistory||[]}function ea(){return x().total||0}function na(t){const e=x();return e.leads=e.leads||[],e.leads.push({ts:bt(),...t}),e.leads.length>50&&(e.leads=e.leads.slice(-50)),D(e),e.leads}function Ft(){return x().examsPassed||[]}function sa(t){const e=x();return e.examsPassed=e.examsPassed||[],e.examsPassed.includes(t)||(e.examsPassed.push(t),D(e)),e.examsPassed}function aa(t){return(x().blockItems||{})[t]||[]}function on(t,e){const n=x();n.blockItems=n.blockItems||{};const a=n.blockItems[t]||[];return a.includes(e)||(a.push(e),n.blockItems[t]=a,D(n)),a}function Y(){return x().modeKey||"ionian"}function cs(t){const e=x();return e.modeKey=t,D(e),t}function xt(){return x().tier||"free"}function _t(t){const e=x();return e.tier=t,D(e),t}const Mt=5,ia=25;function qt(){return Mt}function ft(){const t=x();let e=t.energy==null?Mt:t.energy;if(e<Mt&&t.energyTs){const n=Math.floor((bt()-t.energyTs)/(ia*6e4));n>0&&(e=Math.min(Mt,e+n))}return e}function Gt(t){const e=x(),n=Math.max(0,Math.min(Mt,Math.round(t)));return e.energy=n,e.energyTs=n<Mt?bt():null,D(e),n}function $e(t){return Gt(ft()+t)}function He(){return x().groove||"off"}function ls(t){const e=x();return e.groove=t,D(e),t}function oa(t){const e=x();if(!e.range||!Number.isFinite(e.range.low))return{extended:null};let n=null;return t>e.range.high?(e.range.high=t,n="high"):t<e.range.low&&(e.range.low=t,n="low"),n&&(e.rangeHistory=e.rangeHistory||[],e.rangeHistory.push({date:lt(),low:e.range.low,high:e.range.high}),e.rangeHistory.length>100&&(e.rangeHistory=e.rangeHistory.slice(-100)),D(e)),{extended:n,midi:t}}function st(){const t=x();return t.voice&&t.voice.key?t.voice:null}function cn(t,e=null,n=null){const a=x(),s=a.voice||{};return a.voice={key:t,low:e??s.low??null,high:n??s.high??null},e!=null&&n!=null&&(a.range={low:Math.round(e),high:Math.round(n)},a.rangeHistory=a.rangeHistory||[],a.rangeHistory.push({date:lt(),low:Math.round(e),high:Math.round(n)}),a.rangeHistory.length>100&&(a.rangeHistory=a.rangeHistory.slice(-100))),D(a),a.voice}const ca={easy:.6,medium:.8,fast:1};function Re(){return x().difficulty||"easy"}function rs(t){const e=x();return e.difficulty=t,D(e),t}function la(){return ca[Re()]||.6}function Lt(){return x().guide!==!1}function ds(t){const e=x();return e.guide=!!t,D(e),e.guide}function pt(){return x().headphones===!0}function us(t){const e=x();return e.headphones=!!t,D(e),e.headphones}function ra(){return Lt()?pt()?"continuous":"prehear":"off"}function gt(){const t=x().timbre;return t==="guitar"||t==="soft"?t:"piano"}function ms(t){const e=x();return e.timbre=t,D(e),e.timbre}function hs(){try{const t=navigator.userAgent||"";return/Mobi|Android|iPhone|iPad|iPod/i.test(t)||(navigator.maxTouchPoints||0)>1}catch{return!1}}const qe={quiet:1,normal:1.8,loud:2.8,max:4.2};function da(){return hs()?"loud":"normal"}function re(){const t=x().volume;return qe[t]?t:da()}function de(){return qe[re()]}function vs(t){const e=x();return qe[t]&&(e.volume=t,D(e)),re()}const De={speaker:.09,wired:.12,bt:.24};function ua(){return"speaker"}function ue(){const t=x().route;return De[t]?t:ua()}function ma(t){const e=x();return De[t]&&(e.route=t,delete e.latencyManual,D(e)),ue()}function Pe(){const t=x().latencyManual;return Number.isFinite(t)?t:De[ue()]}function ln(t){const e=x();return e.latencyManual=Math.max(0,Math.min(.5,t)),D(e),e.latencyManual}function Ct(){return x().darkStage===!0}function ha(t){const e=x();return e.darkStage=!!t,D(e),e.darkStage}function It(){return x().micAGC===!0}function va(t){const e=x();return e.micAGC=!!t,D(e),e.micAGC}const bs={low:1.5,med:3,high:5.5};function ba(){return hs()?"high":"med"}function Fe(){const t=x().sensitivity;return bs[t]?t:ba()}function ze(){return bs[Fe()]}function fs(t){const e=x();return e.sensitivity=t,D(e),t}function ps(){return x().breathBest||0}function fa(t){const e=x();return e.breathBest=Math.max(e.breathBest||0,t),D(e),e.breathBest}const Ve=5,pa=7;function Qt(){return x().paywallEnabled===!0}function ge(t){const e=x();return e.paywallEnabled=!!t,D(e),e.paywallEnabled}function gs(){const t=x();return t.trialStart||(t.trialStart=bt(),D(t)),t.trialStart}function Ne(){const t=x().trialStart;if(!t)return null;const e=pa-Math.floor((bt()-t)/864e5);return Math.max(0,e)}function ga(){const t=Ne();return t!=null&&t>0}function ya(){const t=x();delete t.trialStart,D(t)}function wa(){return xt()!=="free"||ga()}function ys(){const t=x();return t.uses&&t.uses.date===lt()?t.uses.count:0}function ws(){const t=x(),e=lt();return t.uses=t.uses&&t.uses.date===e?{date:e,count:t.uses.count+1}:{date:e,count:1},D(t),t.uses.count}function Ea(){return!Qt()||wa()?!1:ys()>=Ve}function $a(){return x().devMode===!0}function Zt(t){const e=x();return e.devMode=!!t,D(e),e.devMode}function ka(t){const e=x();return e.examsPassed=t.slice(),D(e),e.examsPassed}function xa(){const t=x();delete t.examsPassed,delete t.blockItems,D(t)}const te="raspevka.analytics.v1",rn=500;function Ma(t,e={}){try{const n=JSON.parse(localStorage.getItem(te)||"[]");n.push({t:Date.now(),type:t,...e}),n.length>rn&&n.splice(0,n.length-rn),localStorage.setItem(te,JSON.stringify(n))}catch{}}function La(){try{return JSON.parse(localStorage.getItem(te)||"[]")}catch{return[]}}function Ta(){try{localStorage.removeItem(te)}catch{}}function Sa(){const t=La(),e=t.filter(s=>s.type==="exercise_done"),n={};for(const s of e)(n[s.id||"—"]=n[s.id||"—"]||[]).push(s.pct||0);const a=Object.entries(n).map(([s,i])=>({id:s,runs:i.length,avgPct:Math.round(i.reduce((o,c)=>o+c,0)/i.length)})).sort((s,i)=>i.runs-s.runs);return{total:t.length,sessions:e.length,perEx:a}}const Ba="#0e8d7f",Ia="#0a766a",Ca="#687485",Aa="#ffffff",dn="#2a3340",Ha="#cfd6e0",Ra=[0,2,4,5,7,9,11],un=t=>Ra.includes((t%12+12)%12),qa=t=>`C${Math.floor(t/12)-1}`;function Es(t,e){if(t==null||e==null)return"";let n=Math.round(t)-2,a=Math.round(e)+2;for(;(n%12+12)%12!==0;)n--;for(;(a%12+12)%12!==11;)a++;const s=13,i=54,o=9,c=33,l=d=>d>=t&&d<=e,r=[];for(let d=n;d<=a;d++)un(d)&&r.push(d);const u=r.length*s,h={};r.forEach((d,b)=>{h[d]=b*s});let v="";r.forEach((d,b)=>{const m=b*s;v+=`<rect x="${m}" y="0" width="${s-1}" height="${i}" rx="2.5" fill="${l(d)?Ba:Aa}" stroke="${Ha}" stroke-width="1"/>`,(d%12+12)%12===0&&(v+=`<text x="${m+(s-1)/2}" y="${i+11}" text-anchor="middle" fill="${Ca}" font-size="8">${qa(d)}</text>`)});for(let d=n;d<=a;d++){if(un(d))continue;const b=h[d-1];if(b==null)continue;const m=b+s-o/2;v+=`<rect x="${m}" y="0" width="${o}" height="${c}" rx="2" fill="${l(d)?Ia:dn}" stroke="${dn}" stroke-width="1"/>`}return`
  ...
  `;const y=document.getElementById("hw"),w=y.getContext("2d"),A=document.getElementById("msg"),L=document.getElementById("livebar"),p=document.getElementById("target"),S=document.getElementById("yours"),k=document.getElementById("cue");function E(){const M=Math.min(window.devicePixelRatio||1,2);y.width=y.clientWidth*M,y.height=y.clientHeight*M,w.setTransform(M,0,0,M,0,0)}E(),window.addEventListener("resize",E);const H=la(),C={...f,tempo:Math.max(40,Math.round(f.tempo*H))},T=new Ns(y,C,{theme:Ct()?"dark":"light"}),R=new Vs(f.notes.length),$=Pe(),I=pt()||ue()!=="speaker";let q=null,_=null,P=0,Z=0,tt=!1,ut=!1,Nt=0,_e=-1;const wt=[],he=[],Tt=(M,N)=>{const O=setTimeout(M,N);return he.push(O),O};function Ge(){wt.forEach(M=>M&&M.stop&&M.stop()),wt.length=0}function ve(){_&&(cancelAnimationFrame(_),_=null),he.forEach(clearTimeout),he.length=0,window.removeEventListener("resize",E),document.removeEventListener("visibilitychange",We),Ge()}function We(){document.hidden?(_&&(cancelAnimationFrame(_),_=null),Ge(),P&&!tt&&(tt=!0,ut=!0)):ut&&(ut=!1,Ue())}document.addEventListener("visibilitychange",We),document.getElementById("exit").addEventListener("click",()=>{ve(),i()});function Ue(){ve(),ct(t,e,n,a,{...s,explain:!1})}Ut(document.getElementById("gsettings"),Ue,e);const Ot=f.root!=null?f.root:f.notes[0].midi,Rs=Us(f),St=gt();T.draw(0,null,!1),d===0?(A.textContent="Слушай тонику…",en(e.ctx,Ot,0,1.4,.14,St),Tt(()=>{A.textContent="Образец…";const M=Gs(e.ctx,Rs,.34,St);Tt(qs,M*1e3+250)},1650)):(A.textContent=(b>0?"↑ выше":"↓ ниже")+` · повтор ${d+1}/${v.length}`,en(e.ctx,Ot,0,.8,.14,St),Tt(()=>{Kt(e.ctx,0,!0),Tt(Ye,480)},950));function qs(){let M=3;const N=()=>{M>0?(Kt(e.ctx),A.textContent="Приготовься… "+M,M-=1,Tt(N,600)):Ye()};N()}function Ye(){const M=ra();A.textContent=M==="continuous"?"Пой за подсказкой!":M==="prehear"?"Слушай тон и повторяй!":"Пой!",n.reset(),P=performance.now(),Z=P,Nt=P,M==="continuous"?T.timed.forEach(W=>{wt.push(vt(e.ctx,W.hz,Math.max(.2,W.dur*.92),W.start,.1,St))}):M==="prehear"&&T.timed.forEach(W=>{const U=Math.min(.4,W.dur);wt.push(vt(e.ctx,W.hz,U,Math.max(0,W.start-U),.18,St))}),f.drone&&wt.push(In(e.ctx,Ot,T.totalTime+.5,.05));const N=He(),O=N==="auto"?f.grooveStyle||"pop":N;O!=="off"&&(q=Ys(e.ctx,{rootMidi:Ot,tempo:C.tempo,dur:T.totalTime,style:O,gain:.45}),wt.push(q)),Ke()}function Ke(){const M=performance.now(),N=(M-P)/1e3,O=M-Z;Z=M;const W=e.read();let U=!1,et=null;if(W){const mt=n.process(W);U=mt.voiced&&e.rms()>.0025,et=mt.smoothedHz}q&&!I&&q.duck(U);const nt=T.evaluate(N-$,U?et:null,U);if(nt.index>=0){let mt=null;nt.voiced&&et&&T.timed[nt.index]&&(mt=Rt(et,T.timed[nt.index].hz)),R.record(nt.index,nt.zone,O,nt.voiced,mt),nt.zone==="green"&&nt.voiced&&nt.index!==_e&&(ee(12),_e=nt.index)}T.draw(N,U?et:null,U);const Et=T.activeAt(N);if(p.textContent=Et?Da(Et.seg.midi):"—",U&&et){Nt=M;const mt=rt(et);S.textContent=mt?mt.name:"—";const Ps=nt.zone==="green"?"var(--green)":nt.zone==="yellow"?"var(--yellow)":"var(--coral)";if(S.style.color=Et?Ps:"var(--text)",L.style.width=Math.min(100,e.rms()*350)+"%",Et){const Qe=Rt(et,Et.seg.hz);Math.abs(Qe)<=20?(k.textContent="в точку",k.style.color="var(--green)"):Qe<0?(k.textContent="↑ выше",k.style.color="var(--amber)"):(k.textContent="↓ ниже",k.style.color="var(--amber)")}else k.textContent=""}else S.textContent="—",S.style.color="var(--text-dim)",L.style.width="0%",Et&&M-Nt>5e3?(k.textContent="не слышу голос — спой громче",k.style.color="var(--coral)"):k.textContent="";N<T.totalTime?_=requestAnimationFrame(Ke):tt||(tt=!0,Ds())}function Ds(){const M=R.result();ve();const N=s._acc||[];if(N.push(M),v&&v.length>1&&d<v.length-1){ct(t,e,n,a,{...s,repIndex:d+1,_acc:N});return}const O=N.reduce((U,et)=>U+(et.pct||0),0)/N.length,W={pct:O,stars:O>=.85?3:O>=.6?2:O>=.35?1:0,notesHit:M.notesHit,notesTotal:M.notesTotal,avgCents:M.avgCents,perNote:M.perNote,stability:M.stability,vibrato:M.vibrato,repsDone:N.length};if(Ma("exercise_done",{id:a.id,pct:Math.round(O*100),stability:Math.round(M.stability||0),reps:N.length}),l&&l(W),c){c(W);return}if(O>=.5&&os({pct:O,stars:W.stars}),O<.4){if(ft()>0){$e(-1),Xe(W);return}}else O>=.5&&$e(O>=.8?2:1);Je(W)}function Je(M){M.stars>=2&&(zt(M.stars>=3?2:1),ee(M.stars>=3?30:15));const N="★".repeat(M.stars)+"☆".repeat(3-M.stars),O=Math.round(M.pct*100),W=M.stars>=3?"Отлично!":M.stars===2?"Хорошо!":M.stars===1?"Неплохо":"Ещё разок",U=vn(M,a);t.innerHTML=`
    ...
    `,Ut(t,()=>Je(M),e),document.getElementById("again").addEventListener("click",o),document.getElementById("menu").addEventListener("click",i);const et=document.getElementById("next");et&&et.addEventListener("click",r)}function Xe(M){const N=Math.round(M.pct*100),O=vn(M,a);t.innerHTML=`
      <div class="screen summary">
  ...
  `}function Ut(t,e,n){t.querySelectorAll("[data-diff]").forEach(o=>{o.addEventListener("click",()=>{rs(o.dataset.diff),e()})}),t.querySelectorAll("[data-timbre]").forEach(o=>{o.addEventListener("click",()=>{ms(o.dataset.timbre),e()})}),t.querySelectorAll("[data-groove]").forEach(o=>{o.addEventListener("click",()=>{ls(o.dataset.groove),e()})}),t.querySelectorAll("[data-vol]").forEach(o=>{o.addEventListener("click",()=>{if(vs(o.dataset.vol),ce(de()),n&&n.ctx)try{vt(n.ctx,523.25,.5,0,.22,gt())}catch{}e()})});const a=t.querySelector("[data-guidetoggle]");a&&a.addEventListener("click",()=>{ds(!Lt()),e()});const s=t.querySelector("[data-hptoggle]");s&&s.addEventListener("click",()=>{us(!pt()),e()});const i=t.querySelector(".more-settings");i&&i.addEventListener("toggle",()=>{$s=i.open})}function vn(t,e){if(t.stars>=3)return"Чисто и точно! Можно прибавить темп или взять упражнение посложнее.";const n=[],a=t.avgCents;a<=-18?n.push("Ты чаще занижал — тяни ноту чуть выше, поддержи дыханием (опора живота)."):a>=18&&n.push("Ты чаще завышал — не дави, расслабь гортань, целься чуть ниже.");const s=t.perNote.length;if(s>=3){const o=e.notes.map((l,r)=>({i:r,midi:l.midi})).sort((l,r)=>r.midi-l.midi).slice(0,Math.max(1,Math.round(s/3)));o.reduce((l,r)=>l+(t.perNote[r.i]||0),0)/o.length<t.pct-.15&&n.push("Верхние ноты даются хуже — не тянись вверх горлом, добавь головной резонанс и воздух.")}return n.length||n.push("Целься в центр ноты и держи ровно. Включи «подсказку тоном» — попадать заметно легче."),n.join(" ")}const J=(t,e)=>({s:t,b:e});function jt(t,e){const n=[];for(let a=0;a<e;a++)n.push(...t.map(s=>({...s})));return n}const At={air1:{id:"air1",name:"Дыхание: длинные с / ш",kind:"rhythm",tempo:70,desc:"Ровный длинный выдох на «с» и «ш» под метроном — опора и расход воздуха.",how:"«с-с-с» тянем на 4 клика → вдох носом → «ш-ш-ш» на 4 клика → вдох носом. Выдох ровный, без толчков.",steps:jt([J("с",4),J("вдох",2),J("ш",4),J("вдох",2)],4)},air2:{id:"air2",name:"Дыхание: короткий с + 5 ш",kind:"rhythm",tempo:80,desc:"Короткий толчок «с» и серия «ш» — активный выдох и чувство ритма.",how:"Короткий «с», пауза, затем 5 коротких «ш». Между «с» и «ш» НЕ дышим; вдох носом — после серии.",steps:jt([J("с",.5),J("rest",.5),J("ш",.5),J("ш",.5),J("ш",.5),J("ш",.5),J("ш",.5),J("вдох",2)],6)},air3:{id:"air3",name:"Артикуляция: 15 с + 15 ш",kind:"rhythm",tempo:80,desc:"Чёткие короткие «с» и «ш» в ровном пульсе — артикуляция и дыхание.",how:"15 коротких «с» → вдох носом → 15 коротких «ш». Держи ровный пульс с метрономом.",steps:[...jt([J("с",.5)],15),J("вдох",2),...jt([J("ш",.5)],15)]}},Va={с:"С-с-с",ш:"Ш-ш-ш",вдох:"Вдох носом",rest:"·"};function ks(t,e,n,a,{onExit:s,onComplete:i}={}){let o=null,c=null,l=!1;const r=[];function u(){o&&(cancelAnimationFrame(o),o=null),r.forEach(clearTimeout),r.length=0,c&&(c.stop(),c=null),document.removeEventListener("visibilitychange",h)}function h(){document.hidden?(o&&(cancelAnimationFrame(o),o=null),c&&(c.stop(),c=null),l=!0):l&&(l=!1,v())}function v(){u(),t.innerHTML=`
      <div class="screen breathe-intro">
        <div class="game-top"><button class="icon-btn" id="back">‹ Меню</button></div>
    ...
    `,document.getElementById("back").addEventListener("click",()=>{u(),s()}),document.getElementById("go").addEventListener("click",d)}function d(){document.addEventListener("visibilitychange",h);const m=60/a.tempo;let f=0;const g=a.steps.map(C=>{const T={...C,start:f,end:f+C.b};return f+=C.b,T}),y=f,w=y*m;t.innerHTML=`
    ...
    `,document.getElementById("quit").addEventListener("click",()=>{u(),s()});const A=document.getElementById("lbl"),L=document.getElementById("beat"),p=document.getElementById("prog");c=In(e.ctx,n,w+.4);const S=performance.now();let k=-1,E=!1;function H(){const C=(performance.now()-S)/1e3,T=C/m,R=Math.floor(T);R>k&&R<Math.ceil(y)&&(k=R,Kt(e.ctx,0,R%4===0),L.classList.remove("pulse"),L.offsetWidth,L.classList.add("pulse"));const $=g.find(I=>T>=I.start&&T<I.end);$&&(A.textContent=Va[$.s]||"",A.style.color=$.s==="вдох"?"var(--gold)":$.s==="rest"?"var(--text-dim)":"var(--accent-2)"),p.style.width=Math.min(100,C/w*100)+"%",C<w?o=requestAnimationFrame(H):E||(E=!0,b())}o=requestAnimationFrame(H)}function b(){if(u(),i){i({pct:null,rhythm:!0});return}t.innerHTML=`
      <div class="screen summary">
        <div class="stars">🫁</div>
    ...
    `,document.getElementById("go").addEventListener("click",f),document.getElementById("quit").addEventListener("click",a)}function d(){const b=u.filter(L=>L&&typeof L.pct=="number"),m=b.length?b.reduce((L,p)=>L+p.pct,0)/b.length:1,f=m>=.85?3:m>=.6?2:m>=.35?1:0,{streak:g,freezeSpent:y}=os({pct:m,stars:f});zt(2),ee(30);const w="★".repeat(f)+"☆".repeat(3-f),A=Math.round(m*100);t.innerHTML=`
      <div class="screen summary">
    ...
    `,document.getElementById("menu").addEventListener("click",a)}h()}function Oe(t,e,n,{onDone:a,onExit:s,canSkip:i=!1}){let o=null;const c=()=>{o&&cancelAnimationFrame(o),o=null};function l(){c(),n.reset();const v=st(),d=v&&dt(v.key);let b=d?d.group:"муж";t.innerHTML=`
      <div class="screen">
        <div class="game-top">
    ...
    `,document.getElementById("back").addEventListener("click",s),document.getElementById("detect").addEventListener("click",r);function m(){const f=st();document.getElementById("voiceCards").innerHTML=ne.filter(g=>g.group===b).map(g=>`
          <button class="list-item voice-card" data-pick="${g.key}">
            <span class="li-main">${g.name}${f&&f.key===g.key?" ·  выбран":""}</span>
            <span class="li-sub">${g.group==="муж"?"мужской":"женский"} · ${bn(g)}</span>
          </button>`).join(""),document.querySelectorAll("[data-pick]").forEach(g=>g.addEventListener("click",()=>{cn(g.dataset.pick),a(st())}))}document.querySelectorAll("[data-gender]").forEach(f=>f.addEventListener("click",()=>{b=f.dataset.gender,document.querySelectorAll("[data-gender]").forEach(g=>g.classList.toggle("on",g.dataset.gender===b)),m()})),m()}function r(){c(),t.innerHTML=`
      <div class="screen breathe-intro">
    ...
    `,document.getElementById("back").addEventListener("click",l),document.getElementById("go").addEventListener("click",()=>u("low"))}function u(v,d=null){c();const b=v==="low";t.innerHTML=`
    ...
    `,document.getElementById("back").addEventListener("click",()=>b?r():u("low"));const m=document.getElementById("note"),f=document.getElementById("status"),g=document.getElementById("stab"),y=[],w=24,A=1200;let L=0;function p(H){const C=Math.min(...H),T=Math.max(...H);return 1200*Math.log2(T/C)}function S(H){const C=[...H].sort((T,R)=>T-R);return C[Math.floor(C.length/2)]}n.reset(),n.setRange&&n.setRange(55,1300);function k(){const H=e.read();if(H){const{smoothedHz:C,voiced:T}=n.process(H);if(T&&C){const R=rt(C),$=R.name.match(/^([A-G]#?)(-?\d+)$/);if(m.className="note-display green",m.innerHTML=$?`${$[1]}<span class="oct">${$[2]}</span>`:R.name,y.push(C),y.length>w&&y.shift(),y.length>=w&&p(y)<110){L||(L=performance.now());const q=performance.now()-L;g.style.width=Math.min(100,q/A*100)+"%";const _=Math.ceil((A-q)/1e3);if(f.textContent=q<A?`Держи… ${Math.max(1,_)}`:"Готово!",q>=A)return E(Math.round(rt(S(y)).midi))}else L=0,g.style.width="0%",f.textContent="Держи ровнее…"}else m.className="note-display silent",m.textContent="—",L=0,g.style.width="0%",y.length&&(y.length=0),f.textContent="Пой и держи ровно…"}o=requestAnimationFrame(k)}k();function E(H){if(c(),b)u("high",H);else{let C=d,T=H;T<=C&&(T=C+7),h(C,T)}}}function h(v,d){c();const b=Na(v,d);cn(b.key,v,d),zt(2),ee(25),t.innerHTML=`
      <div class="screen summary">
        ...
        <div class="card" style="text-align:left;width:100%">
          ...
          ${Es(v,d)}
          <p class="how"><b>Типичный для ${b.name.toLowerCase()}:</b> ${bn(b)}</p>
    ...
    <svg class="range-tl" viewBox="0 0 ${c} ${l}" preserveAspectRatio="none" role="img" aria-label="График роста диапазона">
      <path d="${v(a)}" class="tl-high"/>
      <path d="${v(n)}" class="tl-low"/>
      <circle cx="${u(e-1)}" cy="${h(a[e-1])}" r="3.5" class="tl-dot-h"/>
      <circle cx="${u(e-1)}" cy="${h(n[e-1])}" r="3.5" class="tl-dot-l"/>
    </svg>`}function Wa(t,{onExit:e}){const n=Zs(),a=ta(),s=le(),i=ea(),o=ps(),c=st(),l=c&&dt(c.key),r=new Set(n.map(f=>f.date)),u=[];for(let f=13;f>=0;f--){const g=new Date(Date.now()-f*864e5);u.push(`<span class="cal-dot ${r.has(_a(g))?"done":""}"></span>`)}const h=n.slice(-12),v=h.length?h.map(f=>{const g=Math.round((f.pct||0)*100);return`<div class="acc-bar ${f.stars>=3?"g":f.stars===2?"a":"c"}" style="height:${Math.max(6,g)}%" title="${g}%"></div>`}).join(""):'<p class="hint">Пройди распевку — здесь появится история точности.</p>';let d="";const b=a.length?a[a.length-1]:c&&c.low!=null?c:null;if(b&&b.low!=null){const f=b.high-b.low;let g="";if(a.length>=2){const y=a[0],w=b.high-b.low-(y.high-y.low);w>0&&(g=` · <span style="color:var(--green)">+${w} пт с начала</span>`)}d=`
      <div class="card" style="text-align:left;width:100%">
        <div class="seg-label">Диапазон голоса</div>
        <p class="how" style="margin-top:6px"><b>${ot(b.low)} – ${ot(b.high)}</b> · ${f} полутонов${g}</p>
        ${Es(b.low,b.high)}
        ${Ga(a)}
  ...
  `,document.getElementById("back").addEventListener("click",()=>{C(),a()});function h(){const T=Fe();document.getElementById("sens").innerHTML=[["low","Низкая"],["med","Средняя"],["high","Высокая"]].map(([R,$])=>`<button data-sens="${R}" class="${T===R?"on":""}">${$}</button>`).join(""),document.querySelectorAll("[data-sens]").forEach(R=>R.addEventListener("click",()=>{fs(R.dataset.sens),e.setSensitivity&&e.setSensitivity(ze()),h()}))}h();const v=document.getElementById("note"),d=document.getElementById("cents"),b=document.getElementById("lvl"),m=document.getElementById("fs"),f=m.getContext("2d");function g(){const T=Math.min(window.devicePixelRatio||1,2);m.width=m.clientWidth*T,m.height=m.clientHeight*T,f.setTransform(T,0,0,T,0,0)}g(),window.addEventListener("resize",g);function y(T,R){const $=Math.max(r,Math.min(u,T)),I=Math.log2($/r)/Math.log2(u/r);return R-I*R}const w=[];n.setRange&&n.setRange(55,1300),n.reset();const A=document.getElementById("cele");let L=null,p=0,S=0,k=null;function E(T){A&&(A.innerHTML=`<svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 2l2.4 6.3L21 9l-5 4.1L17.8 20 12 16.3 6.2 20 8 13.1 3 9l6.6-.7z"/></svg> ${T}`,A.hidden=!1,clearTimeout(k),k=setTimeout(()=>{A&&(A.hidden=!0)},3400))}function H(){const T=m.clientWidth,R=m.clientHeight;f.clearRect(0,0,T,R),f.font="10px Inter, sans-serif";for(let P=Math.ceil(c);P<=l;P++){const Z=y(G(P),R),tt=(P%12+12)%12===0;f.strokeStyle=tt?"rgba(27,36,48,.20)":gn(P)?"rgba(27,36,48,.08)":"rgba(27,36,48,.03)",f.lineWidth=1,f.beginPath(),f.moveTo(34,Z),f.lineTo(T,Z),f.stroke(),gn(P)&&(f.fillStyle=tt?"rgba(27,36,48,.55)":"rgba(27,36,48,.32)",f.fillText(yn(P),4,Z+3))}const $=e.read();let I=!1,q=null;if($){const P=n.process($);I=P.voiced&&e.rms()>.0025,q=P.smoothedHz}if(I&&q){const P=rt(q),Z=(P.name||"").match(/^([A-G]#?)(-?\d+)$/);v.innerHTML=Z?`${Z[1]}<span class="oct">${Z[2]}</span>`:P.name,v.classList.remove("silent"),d.textContent=`центы: ${P.cents>0?"+":""}${P.cents}`,b.style.width=Math.min(100,e.rms()*350)+"%";const tt=y(q,R);w.push(tt);const ut=Math.round(69+12*Math.log2(q/440));Math.abs(P.cents)<42?(ut===L?p++:(L=ut,p=1),p===26&&Date.now()-S>4e3&&oa(ut).extended&&(S=Date.now(),E(`Новая нота — ${yn(ut)}! Диапазон растёт.`))):(L=null,p=0)}else v.textContent="—",v.classList.add("silent"),d.textContent="центы: —",b.style.width="0%",w.push(null),L=null,p=0;for(;w.length>90;)w.shift();const _=T-28;for(let P=0;P<w.length;P++){if(w[P]==null)continue;const Z=_-(w.length-1-P)*2.4,tt=P===w.length-1;f.fillStyle=tt?"#2fab84":"rgba(47,171,132,.35)",tt&&(f.shadowColor="#2fab84",f.shadowBlur=16),f.beginPath(),f.arc(Z,w[P],tt?8:2.5,0,Math.PI*2),f.fill(),f.shadowBlur=0}o=requestAnimationFrame(H)}H();function C(){o&&cancelAnimationFrame(o),o=null,window.removeEventListener("resize",g),clearTimeout(k)}}const Ka=""+new URL("belly-breathing-B0wu-xNS.webp",import.meta.url).href;function Ja(){return`
    ...
    `,document.getElementById("quit").addEventListener("click",()=>{u(),a()});const h=document.getElementById("core"),v=document.getElementById("phase"),d=document.getElementById("count"),b=document.getElementById("cycles");s.cycles*s.phases.length;let m=0,f=0,g=performance.now();y();function y(){b.innerHTML=Array.from({length:s.cycles},(L,p)=>`<span class="dot ${p<m?"done":p===m?"now":""}"></span>`).join("")}function w(){const L=s.phases[f],p=(performance.now()-g)/1e3,S=Math.min(1,p/L.sec),k=L.from+(L.to-L.from)*Xa(S);if(h.style.transform=`scale(${k})`,v.textContent=L.label,d.textContent=Math.ceil(L.sec-p),p>=L.sec){if(f+=1,f>=s.phases.length&&(f=0,m+=1,y()),m>=s.cycles)return A();g=performance.now()}i=requestAnimationFrame(w)}i=requestAnimationFrame(w);function A(){u(),t.innerHTML=`
        <div class="screen summary">
          <div class="stars">🫁</div>
          <div class="verdict">Готово!</div>
    ...
    `,document.getElementById("quit").addEventListener("click",()=>{u(),a()});const h=document.getElementById("timer"),v=document.getElementById("phase"),d=document.getElementById("vol"),b=.012,m=.6;let f="ready",g=0,y=0;function w(){e.read();const L=e.rms();d.style.width=Math.min(100,L*400)+"%";const p=performance.now();if(f==="ready")L>b&&(f="running",g=p,y=p,v.textContent="Тяни ровно!");else if(f==="running"&&(L>b&&(y=p),h.textContent=((p-g)/1e3).toFixed(1),p-y>m*1e3))return A((y-g)/1e3);i=requestAnimationFrame(w)}i=requestAnimationFrame(w);function A(L){u(),L=Math.max(0,Math.round(L*10)/10);const p=fa(L),S=[...s.goals].reverse().find(E=>L>=E.sec),k=S?S.label[0].toUpperCase()+S.label.slice(1)+"!":"Попробуй ещё";t.innerHTML=`
        <div class="screen summary">
      ...
      </div>`,document.getElementById("back").addEventListener("click",e),document.getElementById("prev").addEventListener("click",()=>{n>0&&(n--,a())}),document.getElementById("next").addEventListener("click",()=>{n<Bt.length-1?(n++,a()):e()})}a()}const Za=[0,2,4,5,7,9,12],ti=t=>t[Math.floor(Math.random()*t.length)];function ei(t){const e=rt(G(t));return e?e.name:""}function Ls(t,e,n,{onExit:a,root:s=60}){let o=0,c=0,l=null,r="idle",u=s,h=0,v=null;const d=gt?gt():"piano";t.innerHTML=`
    ...
    </div>`;const b=document.getElementById("status"),m=document.getElementById("bigq"),f=document.getElementById("cue"),g=document.getElementById("lvl"),y=document.getElementById("score");document.getElementById("back").addEventListener("click",()=>{H(),a()}),document.getElementById("replay").addEventListener("click",w),document.getElementById("skip").addEventListener("click",()=>{L("Пропущено"),S(1300)}),n.setRange&&n.setRange(55,1300),n.reset();function w(){e.ctx&&vt(e.ctx,G(u),1.3,0,.3,d),f.textContent="Слушай…",r="wait",clearTimeout(v),v=setTimeout(()=>{r="sing",f.textContent="Теперь спой эту ноту"},1350)}function A(){o++,u=s+ti(Za),h=0,m.textContent="?",m.classList.add("silent"),b.textContent=`Раунд ${o} / 8`,w()}function L(C){m.textContent=ei(u),m.classList.remove("silent"),C&&(f.textContent=C),r="done"}function p(){c++,y.textContent=`Верно: ${c} / 8`,L("Верно! Бра-во."),m.classList.add("hit"),S(1300)}function S(C){clearTimeout(v),v=setTimeout(()=>{m.classList.remove("hit"),o>=8?k():A()},C)}function k(){H(),t.innerHTML=`
      <div class="screen summary">
  ...
  </div>`}function oi(t,{blocks:e,examsPassed:n,onExit:a,onOpenBlock:s,onSchool:i}){const o=e.filter(r=>n.includes(r.id)).length,c=e.map((r,u)=>{const h=n.includes(r.id),v=ii(u,n),d=h?"done":v?"open":"locked",b=h?"✓":v?`${u+1}`:"🔒";return`<button class="block-card ${d}" data-block="${u}" ${v?"":"disabled"}>
  ...
  `,document.getElementById("back").addEventListener("click",i),t.querySelectorAll("[data-item]").forEach(d=>d.addEventListener("click",()=>o(e,Number(d.dataset.item)))),document.getElementById("exam").addEventListener("click",()=>c(e));const v=document.getElementById("toSchool");v&&l&&v.addEventListener("click",l)}function li(){const t=["audio/webm;codecs=opus","audio/webm","audio/mp4","audio/ogg"];for(const e of t)try{if(window.MediaRecorder&&MediaRecorder.isTypeSupported(e))return e}catch{}return""}function ri(t,e,{onExit:n}){let a=null,s=[],i=null,o=null,c=0,l=!1;function r(b){const m=Math.floor(b/1e3);return`${Math.floor(m/60)}:${String(m%60).padStart(2,"0")}`}function u(){t.innerHTML=`
  ...
  `;const v=document.getElementById("back"),d=document.getElementById("play"),b=document.getElementById("cur"),m=document.getElementById("dur"),f=document.getElementById("seek"),g=document.getElementById("note"),y=document.getElementById("fs"),w=y.getContext("2d");function A(){const E=Math.min(window.devicePixelRatio||1,2);y.width=y.clientWidth*E,y.height=y.clientHeight*E,w.setTransform(E,0,0,E,0,0)}A(),window.addEventListener("resize",A),h.addEventListener("loadedmetadata",()=>{m.textContent=kn(h.duration)}),h.addEventListener("ended",()=>{d.textContent="▶ Слушать"}),d.addEventListener("click",()=>{h.paused?(h.play().catch(()=>{}),d.textContent="⏸ Пауза"):(h.pause(),d.textContent="▶ Слушать")}),v.addEventListener("click",()=>{k(),a()});function L(E,H){const C=Math.max(r,Math.min(u,E)),T=Math.log2(C/r)/Math.log2(u/r);return H-T*H}const p=[];n.setRange&&n.setRange(55,1300),n.reset();function S(){const E=y.clientWidth,H=y.clientHeight;w.clearRect(0,0,E,H),w.font="10px Inter, sans-serif";for(let I=Math.ceil(c);I<=l;I++){const q=L(G(I),H),_=(I%12+12)%12===0;w.strokeStyle=_?"rgba(27,36,48,.20)":$n(I)?"rgba(27,36,48,.08)":"rgba(27,36,48,.03)",w.lineWidth=1,w.beginPath(),w.moveTo(34,q),w.lineTo(E,q),w.stroke(),$n(I)&&(w.fillStyle=_?"rgba(27,36,48,.55)":"rgba(27,36,48,.32)",w.fillText(mi(I),4,q+3))}h.duration&&(f.style.width=Math.min(100,h.currentTime/h.duration*100)+"%",b.textContent=kn(h.currentTime));const C=e.read();let T=!1,R=null;if(C){const I=n.process(C);T=I.voiced&&e.rms()>.0025,R=I.smoothedHz}if(T&&R){const I=rt(R),q=(I.name||"").match(/^([A-G]#?)(-?\d+)$/);g.innerHTML=q?`${q[1]}<span class="oct">${q[2]}</span>`:I.name,g.classList.remove("silent"),p.push(L(R,H))}else g.textContent="—",g.classList.add("silent"),p.push(null);for(;p.length>90;)p.shift();const $=E-28;for(let I=0;I<p.length;I++){if(p[I]==null)continue;const q=$-(p.length-1-I)*2.4,_=I===p.length-1;w.fillStyle=_?"#2fab84":"rgba(47,171,132,.35)",_&&(w.shadowColor="#2fab84",w.shadowBlur=16),w.beginPath(),w.arc(q,p[I],_?8:2.5,0,Math.PI*2),w.fill(),w.shadowBlur=0}o=requestAnimationFrame(S)}S();function k(){o&&cancelAnimationFrame(o),o=null,window.removeEventListener("resize",A);try{h.pause(),h.src=""}catch{}}}async function vi(t){return!1}function bi(t,{onExit:e}){const n=st(),a=n&&dt(n.key),s=Js(),i={voiceType:a?a.name:null,range:s&&Number.isFinite(s.low)?`${ot(s.low)}–${ot(s.high)}`:null,streak:le(),blocks:Ft().length},o=[i.voiceType,i.range?`диапазон ${i.range}`:null,i.streak?`стрик ${i.streak}`:null,i.blocks?`блоков ${i.blocks}`:null].filter(Boolean).join(" · ")||"пока без данных";let c="any";function l(){t.innerHTML=`
    ...
    `,document.getElementById("lf-ok").addEventListener("click",e)}l()}function fi(t,e,{onExit:n,onVoice:a,onCalibrate:s}){let i=!1;function o(r,u,h){return`<div class="seg">${r.map(([v,d])=>`<button data-${h}="${v}" class="${u===v?"on":""}">${d}</button>`).join("")}</div>`}function c(){const r=Sa();if(!r.sessions)return"";const u=r.perEx.slice(0,6).map(h=>`<div class="an-row"><span>${h.id}</span><span>${h.runs}× · ${h.avgPct}%</span></div>`).join("");return`
      <div class="card">
      ...
      <div class="screen settings-screen">
        ...
        <div class="card settings">
          ...
          <button class="toggle ${It()?"on":""}" id="agc" style="width:100%;margin-top:8px">Авто-громкость микро (AGC): ${It()?"вкл":"выкл"} <span class="set-hint">${It()?"громче на телефоне":"ровнее долгие ноты"}</span></button>
        </div>
    ...
    `,document.getElementById("back").addEventListener("click",n),document.getElementById("voice").addEventListener("click",a),t.querySelectorAll("[data-vol]").forEach(v=>v.addEventListener("click",()=>{if(vs(v.dataset.vol),ce(de()),e&&e.ctx)try{vt(e.ctx,523.25,.5,0,.22,gt())}catch{}l()})),t.querySelectorAll("[data-route]").forEach(v=>v.addEventListener("click",()=>{ma(v.dataset.route),l()})),t.querySelectorAll("[data-sens]").forEach(v=>v.addEventListener("click",()=>{fs(v.dataset.sens),e&&e.setSensitivity&&e.setSensitivity(ze()),l()})),t.querySelectorAll("[data-diff]").forEach(v=>v.addEventListener("click",()=>{rs(v.dataset.diff),l()})),t.querySelectorAll("[data-timbre]").forEach(v=>v.addEventListener("click",()=>{ms(v.dataset.timbre),l()})),t.querySelectorAll("[data-groove]").forEach(v=>v.addEventListener("click",()=>{ls(v.dataset.groove),l()})),document.getElementById("guide").addEventListener("click",()=>{ds(!Lt()),l()}),document.getElementById("hp").addEventListener("click",()=>{us(!pt()),l()}),document.getElementById("darkstage").addEventListener("click",()=>{ha(!Ct()),l()}),document.getElementById("agc").addEventListener("click",()=>{const v=!It();va(v),e&&e.setAGC&&e.setAGC(v),l()});const h=document.getElementById("calib");h&&s&&h.addEventListener("click",s),document.getElementById("reset").addEventListener("click",()=>{if(!i){i=!0,l();return}is(),Ta(),n()})}l()}function pi(t,e,{k:n=4,minRms:a=.012,window:s=.5}={}){if(!Array.isArray(t)||t.length<3)return null;const i=t.filter(l=>l.t<e).map(l=>l.rms).sort((l,r)=>l-r);if(!i.length)return null;const o=i[Math.floor(i.length/2)]||0,c=Math.max(a,o*n);for(const l of t)if(!(l.t<=e)){if(l.t-e>s)break;if(l.rms>=c)return l.t-e}return null}function gi(t,e=.03,n=.4){const a=t.filter(s=>Number.isFinite(s)&&s>=e&&s<=n).sort((s,i)=>s-i);return a.length<2?null:a[Math.floor(a.length/2)]}const yi=t=>new Promise(e=>setTimeout(e,t));function wi(t,e,{onExit:n}){let a=!1,s="";function i(){const l=Math.round(Pe()*1e3);t.innerHTML=`
    ...
    `,document.getElementById("back").addEventListener("click",n),document.getElementById("measure").addEventListener("click",c);const r=document.getElementById("slider");r.addEventListener("input",()=>{const u=Number(r.value);document.getElementById("slval").textContent=u+" мс",document.getElementById("curms").textContent=u,ln(u/1e3)})}function o(){return new Promise(l=>{const r=e.ctx;if(!r){l(null);return}const u=[],h=r.currentTime,v=typeof performance<"u"?performance.now():Date.now(),d=h+.15;Kt(r,.15,!0);const b=()=>{e.read(),u.push({t:r.currentTime,rms:e.rms()});const m=r.currentTime-h,f=((typeof performance<"u"?performance.now():Date.now())-v)/1e3;m<.7&&f<1.3?setTimeout(b,16):l(pi(u,d))};b()})}async function c(){if(a)return;a=!0,s="",i();const l=[];for(let u=0;u<3;u++)s=`Замер ${u+1} из 3…`,i(),l.push(await o()),await yi(300);const r=gi(l);a=!1,r==null?s="Не удалось расслышать эхо (тихо, наушники или сильный шум). Подстрой вручную ползунком ниже или выбери тип вывода в настройках.":(ln(r),s=`Готово: задержка ≈ ${Math.round(r*1e3)} мс — сохранено.`),i()}i()}function Bs(t,{onExit:e}){const n=()=>Bs(t,{onExit:e}),a=as(),s=lt(),i=Ne(),o=(l,r)=>`
    <div class="seg-label">${l}</div>
    <div class="seg">${r.map(([u,h,v])=>`<button data-act="${u}" class="${v?"on":""}">${h}</button>`).join("")}</div>`;t.innerHTML=`
    <div class="screen catalog">
      <div class="game-top"><button class="icon-btn" id="back">‹ Меню</button></div>
  ...
  `,document.getElementById("back").addEventListener("click",e),document.getElementById("exitDev").addEventListener("click",()=>{Zt(!1),fe(),e()}),document.getElementById("simNew").addEventListener("click",()=>{is(),fe(),Zt(!0),ge(!0),n()});const c={"d-1":()=>be(-1),"d+1":()=>be(1),"d+7":()=>be(7),d0:()=>fe(),s0:()=>pe(0),s6:()=>pe(6),s13:()=>pe(13),fz:()=>Xs(Xt()+1),e0:()=>Gt(0),e1:()=>Gt(1),emax:()=>Gt(qt()),"pw-on":()=>ge(!0),"pw-off":()=>ge(!1),"pw-use":()=>ws(),"tr-start":()=>gs(),"tr-reset":()=>ya(),"tier-free":()=>_t("free"),"tier-std":()=>_t("standard"),"tier-pro":()=>_t("pro"),"bl-all":()=>ka(at.map(l=>l.id)),"bl-none":()=>xa()};t.querySelectorAll("[data-act]").forEach(l=>{l.addEventListener("click",()=>{c[l.dataset.act](),n()})})}function Ei(t,{onExit:e,onTrialStarted:n,onTeacher:a}){const s=Ne()!=null;t.innerHTML=`
    <div class="screen summary">
      <div class="game-top"><button class="icon-btn" id="back">‹ Меню</button></div>
      <div class="brand">
  ...
  `,document.getElementById("back").addEventListener("click",e);const s=document.getElementById("toSettings");s&&n&&s.addEventListener("click",n)}const B=document.getElementById("app"),j=new Fs({fftSize:2048});let K=null,ye=null;const xi=60,Yt=[{label:"Мычание по гамме",sub:"«М» · I-II-III-II-I",ic:"lips",cat:"warm",make:t=>Se(t,Y())},{label:"Губной тренаж «brrr»",sub:"brrr / «Р» · 5 нот + квинта",ic:"wave",cat:"warm",make:t=>Be(t,Y())},{label:"Удержание ноты",sub:"держать ровный звук",ic:"fork",cat:"warm",make:t=>Vn(t,8)},{label:"Гамма «Ма-Мэ»",sub:"попадать в ноты гаммы",ic:"stairs",cat:"pitch",make:t=>Zn(t,Y())},{label:"Беглость «Ма»",sub:"быстрые ноты — как в рекламе",ic:"bolt",cat:"pitch",make:t=>ts(t,Y())},{label:"Октавный скачок",sub:"прыжок на октаву и назад",ic:"arrows",cat:"pitch",make:t=>es(t)},{label:"Цепочка гласных",sub:"Ми-Ме-Ма · выравнивание",ic:"lips",cat:"vowel",make:t=>Pn(t,Y())},{label:"Calm Down Vowels",sub:"И-Э-А-О-У · позиция",ic:"lips",cat:"vowel",make:t=>An(t)},{label:"Disco Vowels",sub:"И-Э-А-О-У · точность",ic:"stairs",cat:"vowel",make:t=>Hn(t,Y())},{label:"James Charles Warm Up",sub:"гласные + Ми-Ме-Ма",ic:"wave",cat:"vowel",make:t=>Dn(t,Y())},{label:"High Five",sub:"И-Э-А-О-У · подъём",ic:"arrows",cat:"vowel",make:t=>qn(t,Y())},{label:"No Bubble Gum",sub:"гибкость на гласных",ic:"bolt",cat:"vowel",make:t=>Rn(t,Y())},{label:"Скачок к V ступени",sub:"Ям · атака интервала",ic:"arrows",cat:"pitch",make:t=>Fn(t,Y())},{label:"Ладовая «ЯМ»",sub:"гамма лада вверх-вниз",ic:"stairs",cat:"pitch",make:t=>zn(t,Y())},{label:"Вибрато",sub:"ровная волна голосом",ic:"wave",cat:"vib",make:t=>Nn(t)},{label:"Раскачка вибрато",sub:"А · запуск вибрато",ic:"wave",cat:"vib",make:t=>On(t)},{label:"Тёплый тон",sub:"Мо · качество тембра",ic:"fork",cat:"vib",make:t=>jn(t)},{label:"Ровный тон на двух",sub:"А · единый тембр",ic:"fork",cat:"vib",make:t=>_n(t)},{label:"Через регистры",sub:"Но · passaggio",ic:"arrows",cat:"reg",make:t=>Gn(t)},{label:"Октавная связка",sub:"А · соединить регистры",ic:"arrows",cat:"reg",make:t=>Wn(t)},{label:"Белтинг — гамма",sub:"Эй · яркая подача",ic:"bolt",cat:"reg",make:t=>Un(t)},{label:"Белт — октава",sub:"Эй · опёртый верх",ic:"arrows",cat:"reg",make:t=>Yn(t)},{label:"Чёткое стаккато",sub:"Та · артикуляция",ic:"bolt",cat:"artic",make:t=>Kn(t)},{label:"Слоги по группам",sub:"Та-Ка · дикция",ic:"lips",cat:"artic",make:t=>Jn(t)},{label:"Стамина-фигура",sub:"Ма · выносливость",ic:"stairs",cat:"artic",make:t=>Xn(t)},{label:"Выносливая гамма",sub:"Ма · длинный пробег",ic:"stairs",cat:"artic",make:t=>Qn(t)}],Mi=[["warm","Разогрев"],["vowel","Гласные"],["pitch","Точность и гибкость"],["vib","Вибрато и тембр"],["reg","Регистры и сила"],["artic","Дикция и выносливость"]];function Dt(){const t=st(),e=t&&dt(t.key);return e?e.center:xi}function se(){const t=st(),e=t&&dt(t.key);return t&&t.low!=null&&t.high!=null?{low:t.low,high:t.high}:e?{low:e.low,high:e.high}:{low:48,high:72}}function it(){if(!K)return;const t=st(),e=t&&dt(t.key);e?K.setRange(G(e.low-5),G(e.high+5)):K.setRange(60,1200)}const Li=["Голос — это мышца. Сегодня сделаем её сильнее.","Дыши животом — и звук польётся сам.","Чисто — не значит громко. Решает точность.","Каждая распевка чуть-чуть расширяет диапазон.","Расслабь челюсть и плечи — голос любит свободу.","Лучшие певцы тоже начинали с простого «мычания».","Тёплый голос начинается с тёплого дыхания.","Не тянись за верхней нотой горлом — она придёт сама.","5 минут каждый день дают больше, чем час раз в неделю.","Улыбнись — и тембр станет светлее.","Зевни перед распевкой — гортань скажет спасибо.","Пой так, будто тебя уже любят слушать."];function Ti(t){const e=t.slice();for(let n=e.length-1;n>0;n--){const a=Math.floor(Math.random()*(n+1));[e[n],e[a]]=[e[a],e[n]]}return e}function Si(){Q();const t=Ti(Li);B.innerHTML=`
  ...
  `;const e=window.matchMedia&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;setTimeout(Bi,e?1600:2800)}function Bi(){Hi();try{new URLSearchParams(location.search).has("dev")&&Zt(!0)}catch{}if(!st()&&!x().welcomed){Ii();return}F()}function Ii(){Q(),B.innerHTML=`
  ...
  `;const t=()=>D({...x(),welcomed:!0});document.getElementById("wlc-skip").addEventListener("click",()=>{t(),F()}),document.getElementById("wlc-go").addEventListener("click",()=>{t(),X(()=>Oe(B,j,K,{onDone:()=>{it(),Ci()},onExit:F}))})}function Ci(){Q(),B.innerHTML=`
    <div class="screen welcome">
  ...
  `,document.getElementById("fe-go").addEventListener("click",()=>ie(0)),document.getElementById("fe-guide").addEventListener("click",Cs),document.getElementById("fe-menu").addEventListener("click",F)}let ht="off";async function Is(){try{if(!j.ready){j.setAGC(It());const{sampleRate:t}=await j.start();K||(K=new zs(t,{fftSize:2048,minClarity:.85})),j.setSensitivity(ze()),ce(de()),it()}return ht="listening",ae(),!0}catch{return ht="denied",ae(),!1}}async function Ai(){if(ht==="listening"){try{await j.suspend()}catch{}ht="off",ae()}else await Is()}function Hi(){const t=document.getElementById("mic-fab");t&&(t.hidden=!1,t.__wired||(t.addEventListener("click",Ai),t.__wired=!0),ae())}function ae(){const t=document.getElementById("mic-fab");if(!t)return;t.className="mic-fab "+ht;const e=t.querySelector(".mic-fab-txt");e&&(e.textContent=ht==="listening"?"Слушаю":ht==="denied"?"Нет доступа · нажми":"Включить микрофон"),t.setAttribute("aria-pressed",ht==="listening"?"true":"false")}async function X(t){if(!await Is()){Ri(t);return}t()}function Ri(t){Q(),B.innerHTML=`
    <div class="screen">
      <div class="game-top"><button class="icon-btn" id="back">‹ Меню</button></div>
  ...
  `,document.getElementById("back").addEventListener("click",F),document.getElementById("grant").addEventListener("click",()=>X(t))}function we(t){return`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">${{mic:'<path d="M12 3a3 3 0 0 0-3 3v6a3 3 0 0 0 6 0V6a3 3 0 0 0-3-3z"/><path d="M5 11a7 7 0 0 0 14 0M12 18v3"/>',chart:'<path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/>',tuner:'<circle cx="12" cy="12" r="8"/><path d="M12 12l4-3"/><path d="M12 4v2M12 18v2M4 12h2M18 12h2"/>',wave:'<path d="M2 12h2l2-6 3 14 3-12 2 8 2-4h6"/>',note:'<circle cx="7" cy="18" r="3"/><circle cx="18" cy="16" r="3"/><path d="M10 18V5l11-2v13"/>',lips:'<path d="M3 12c4-5 14-5 18 0-4 5-14 5-18 0z"/><path d="M3 12h18"/>',fork:'<path d="M9 3v8a3 3 0 0 0 6 0V3"/><path d="M12 14v7"/>',stairs:'<path d="M3 19h4v-4h4v-4h4V7h4"/>',bolt:'<path d="M13 2 4 14h6l-1 8 9-12h-6z"/>',arrows:'<path d="M8 8l4-4 4 4M8 16l4 4 4-4M12 4v16"/>'}[t]||""}</svg>`}function qi(){return'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c1 3-1 4-2 6-1 1.7-.5 3.5 1 4 .8.3 1-.7.5-1.5 2 .6 3.5 2.3 3.5 4.5A5 5 0 0 1 7 19c-1.7-1-2.7-3-2.5-5 .2-2.4 2-3.7 2.8-5.6C8.4 6 9 3.6 12 2z"/></svg>'}const Ee=t=>t%10===1&&t%100!==11?"день":"дн.";function F(){Q();const t=($,I)=>{const q=$.make(60).notes;return`
    <button class="ex-tile" data-ex="${I}">
      ${ke(q)}
      <span class="ex-tile-main">${$.label}</span>
      <span class="ex-tile-sub">${$.sub}</span>
    </button>`},e=Mi.map(([$,I])=>{const q=Yt.map((_,P)=>_.cat===$?t(_,P):"").join("");return`<div class="cat-title">${I}</div><div class="ex-row">${q}</div>`}).join(""),n=Ft(),a=at.findIndex($=>!n.includes($.id)),s=Math.round(n.length/at.length*100),i=Object.entries(xs).map(([$,I])=>`
    <button class="thin-item" data-breath="${$}"><span>${I.title}</span><span class="thin-sub">${I.kind==="exhale"?"выдох":"дыхание"}</span></button>
  `).join(""),o=Object.entries(At).map(([$,I])=>`
    <button class="thin-item" data-rhythm="${$}"><span>${I.name}</span><span class="thin-sub">метроном</span></button>
  `).join(""),c=Ts.map(($,I)=>`
    <button class="ex-tile" data-song="${I}">
      ${ke(ni($))}
      <span class="ex-tile-main">${$.name}</span>
      <span class="ex-tile-sub">мелодия · на «ля»</span>
    </button>`).join(""),l=le(),r=st(),u=r&&dt(r.key),h=Qs(),v=ss(),d=(v.getDate()+v.getMonth())%Yt.length,b=Yt[d],m=Te(Y()).name,f=ft(),g=qt();B.innerHTML=`
    <div class="screen home">
      <header class="home-head">
        ...
        <div class="home-chips">
          ...
          ${l>0?`<div class="streak-chip" title="Стрик: ${l} ${Ee(l)} подряд">${qi()} ${l}</div>`:""}
  ...
  `,document.getElementById("session").addEventListener("click",()=>{const $=()=>X(()=>{it(),Oa(B,j,K,{onExit:F})});x().safetyAccepted?$():zi($)});const y=B.querySelector("[data-focus]");y&&y.addEventListener("click",()=>ie(d)),B.querySelector("[data-voice]").addEventListener("click",()=>{X(()=>Oe(B,j,K,{onDone:()=>{it(),F()},onExit:F}))}),B.querySelector("[data-dash]").addEventListener("click",()=>Wa(B,{onExit:F})),B.querySelector("[data-freesing]").addEventListener("click",()=>{X(()=>{const $=se();Ya(B,j,K,{onExit:()=>{it(),F()},lowMidi:$.low,highMidi:$.high})})}),B.querySelectorAll("[data-ex]").forEach($=>{$.addEventListener("click",()=>ie(Number($.dataset.ex)))}),B.querySelectorAll("[data-breath]").forEach($=>{$.addEventListener("click",()=>X(()=>Ms(B,j,$.dataset.breath,{onExit:F})))}),B.querySelectorAll("[data-rhythm]").forEach($=>{$.addEventListener("click",()=>ks(B,j,Dt(),At[$.dataset.rhythm],{onExit:F}))});const w=B.querySelector("[data-path]");w&&w.addEventListener("click",je);const A=B.querySelector("[data-ear]");A&&A.addEventListener("click",()=>X(()=>{it(),Ls(B,j,K,{onExit:F,root:Dt()})}));const L=B.querySelector("[data-theory]");L&&L.addEventListener("click",()=>Qa(B,{onExit:F}));const p=B.querySelector("[data-record]");p&&p.addEventListener("click",()=>X(()=>ri(B,j,{onExit:F})));const S=B.querySelector("[data-backing]");S&&S.addEventListener("click",()=>X(()=>{const $=se();hi(B,j,K,{onExit:()=>{it(),F()},lowMidi:$.low,highMidi:$.high})}));const k=B.querySelector("[data-modes]");k&&k.addEventListener("click",Pi);const E=B.querySelector("[data-settings]");E&&E.addEventListener("click",Ht);const H=B.querySelector("[data-teacher]");H&&H.addEventListener("click",()=>Vt(F)),B.querySelectorAll("[data-song]").forEach($=>{$.addEventListener("click",()=>Hs(Number($.dataset.song)))});const C=B.querySelector("[data-guide]");C&&C.addEventListener("click",Cs);const T=B.querySelector("[data-dev]");T&&T.addEventListener("click",xn);const R=B.querySelector(".home-head h1");if(R){let $=0,I=0;R.addEventListener("click",()=>{const q=Date.now();$=q-I<600?$+1:1,I=q,$>=7&&($=0,Zt(!0),xn())})}}function xn(){Q(),Bs(B,{onExit:F})}function Cs(){Q(),ki(B,{onExit:F,onSettings:Ht})}function Di(){Q(),Ei(B,{onExit:F,onTrialStarted:F,onTeacher:()=>Vt(F)})}function As(t){if(Ea()){Di();return}Qt()&&ws(),t()}function ie(t,e=!0){if(e){As(()=>Mn(t,e));return}Mn(t,e)}function oe(t){const e=se(),n=t(60),a=Math.min(...n.notes.map(c=>c.midi))-60,s=e.low-a,i=t(s),o=Ie(i,e.low,e.high,48);return{ex:i,reps:o}}function Mn(t,e){X(()=>{it();const n=i=>Yt[t].make(i),{ex:a,reps:s}=oe(n);ct(B,j,K,a,{explain:e,reps:s,rebuild:()=>oe(n).ex,onExit:F,onAgain:()=>ie(t,!1)})})}function Hs(t,e=!0){if(e){As(()=>Ln(t,e));return}Ln(t,e)}function Ln(t,e){X(()=>{const n=Ts[t].make(Dt());ct(B,j,K,n,{explain:e,reps:[0],onExit:F,onAgain:()=>Hs(t,!1)})})}function Pi(){Q(),ai(B,{onExit:F})}function je(){Q(),oi(B,{blocks:at,examsPassed:Ft(),onExit:F,onOpenBlock:Pt,onSchool:Vt})}function Pt(t){Q();const e=at[t];ci(B,{block:e,index:t,examsPassed:Ft(),doneItems:aa(e.id),onExit:je,onRunItem:Le,onExam:me,onSchool:Vt})}function Le(t,e){const n=t.items[e],a=at.indexOf(t),s=t.items[e+1],i=()=>s?Le(t,e+1):me(t);X(()=>{if(it(),n.t==="breath"){Ms(B,j,n.id,{onExit:()=>{on(t.id,n.id),i()}});return}const o=r=>Me[n.id](r,Y()),{ex:c,reps:l}=oe(o);ct(B,j,K,c,{explain:!0,reps:l,rebuild:()=>oe(o).ex,onResult:r=>{r.pct>=.5&&on(t.id,n.id)},onExit:()=>Pt(a),onAgain:()=>Le(t,e),nextLabel:s?`Дальше: ${s.name}`:"К экзамену блока",onNext:i})})}function me(t){X(()=>{it();const e=Me[t.exam.exId](Dt(),Y()),n=se(),a=Ie(e,n.low,n.high,2);ct(B,j,K,e,{explain:!0,reps:a,rebuild:()=>Me[t.exam.exId](Dt(),Y()),onComplete:s=>Fi(t,s),onExit:()=>Pt(at.indexOf(t)),onAgain:()=>me(t)})})}function Fi(t,e){Q();const n=Math.round(e.pct*100),a=e.pct>=t.exam.pass;a?sa(t.id):ft()>0&&$e(-1);const s=at.indexOf(t),i=a&&s+1<at.length,o=a?"var(--green)":"var(--coral)";B.innerHTML=`
    <div class="screen summary">
    ...
    </div>`,document.getElementById("toBlock").addEventListener("click",()=>Pt(s)),document.getElementById("toSchool").addEventListener("click",Vt),document.getElementById("primary").addEventListener("click",()=>{a?i?Pt(s+1):je():me(t)})}function Vt(t){Q(),bi(B,{onExit:typeof t=="function"?t:F})}function Ht(){Q(),fi(B,j,{onExit:F,onVoice:()=>X(()=>Oe(B,j,K,{onDone:()=>{it(),Ht()},onExit:Ht})),onCalibrate:()=>X(()=>wi(B,j,{onExit:Ht}))})}function zi(t){Q(),B.innerHTML=`
    <div class="screen">
  ...
  `,document.getElementById("accept").addEventListener("click",()=>{D({...x(),safetyAccepted:!0}),t()}),document.getElementById("safety-back").addEventListener("click",F)}function Q(){ye&&cancelAnimationFrame(ye),ye=null}"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("./sw.js").catch(()=>{})});Si();
