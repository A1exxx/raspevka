...
const LIST = [
  ...
  ['07', 'Раскачка вибрато', () => vibratoWobble(71)],
  ['08', 'Тёплый тон', () => timbreVocalise(64)],
  ['09', 'Ровный тон на двух', () => timbreShift(62)],
  ['10', 'Через регистры', () => registerArp(64)],
  ['11', 'Октавная связка', () => registerOctave(64)],
