...
const EXERCISES = [
  ...
  { label: 'Пять гласных', sub: 'И-Э-А-О-У · позиция', ic: 'lips', cat: 'vowel', make: (r) => vowelHold(r) },
  { label: 'Лесенка гласных', sub: 'И-Э-А-О-У · точность', ic: 'stairs', cat: 'vowel', make: (r) => vowelScale(r, progress.getModeKey()) },
  { label: 'Волна гласных', sub: 'мотив с паузами + спуск', ic: 'wave', cat: 'vowel', make: (r) => jamesCharles(r, progress.getModeKey()) },
  { label: 'Качели на квинте', sub: 'И-Э-А-О-У · скачки', ic: 'arrows', cat: 'vowel', make: (r) => vowelClimb(r, progress.getModeKey()) },
  { label: 'Зигзаг', sub: 'гибкость на гласных', ic: 'bolt', cat: 'vowel', make: (r) => vowelAgility(r, progress.getModeKey()) },
  ...
  { label: 'Белт-арпеджио', sub: 'Эй · опёртый верх', ic: 'arrows', cat: 'reg', make: (r) => beltOctave(r) },
  { label: 'Стаккато-арпеджио', sub: 'Та · артикуляция', ic: 'bolt', cat: 'artic', make: (r) => articStaccato(r) },
  { label: 'Слоги по группам', sub: 'Та-Ка · дикция', ic: 'lips', cat: 'artic', make: (r) => articGroups(r) },
  { label: 'Фигура-волчок', sub: 'Ма · выносливость', ic: 'stairs', cat: 'artic', make: (r) => resistTurn(r) },
